/*** Autogenerated by WIDL <undefined version> from /home/alice/Estudos/ReactOS/ReactOSRCCompile1/sdk/include/wine/irot.idl - Do not edit ***/
#include <string.h>

#include "irot_s.h"

#define TYPE_FORMAT_STRING_SIZE 187
...
static const unsigned short Irot_FormatStringOffsetTable[] =
{
    ...
    134,  /* IrotIsRunning */
    174,  /* IrotGetObject */
    226,  /* IrotNoteChangeTime */
    272,  /* IrotGetTimeOfLastChange */
    318,  /* IrotEnumRunning */
};
...
/* 128 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 134 (procedure Irot::IrotIsRunning) */
        0x00,	/* explicit handle */
        0x48,
        NdrFcLong(0x0),
...
/* 168 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 174 (procedure Irot::IrotGetObject) */
        0x00,	/* explicit handle */
        0x48,
        NdrFcLong(0x0),
...
/* 220 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 226 (procedure Irot::IrotNoteChangeTime) */
        0x00,	/* explicit handle */
        0x48,
        NdrFcLong(0x0),
...
/* 266 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 272 (procedure Irot::IrotGetTimeOfLastChange) */
        0x00,	/* explicit handle */
        0x48,
        NdrFcLong(0x0),
...
/* 312 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 318 (procedure Irot::IrotEnumRunning) */
        0x00,	/* explicit handle */
        0x48,
        NdrFcLong(0x0),
...
/* 134 (PInterfaceData[]) */
        ...
        NdrFcShort(0x1),
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xff94),	/* Offset= -108 (38) */
        0x5c,	/* FC_PAD */
        0x5b,	/* FC_END */
/* 150 (InterfaceList) */
        0x18,	/* FC_CPSTRUCT */
        0x3,	/* 3 */
        NdrFcShort(0x4),	/* 4 */
        NdrFcShort(0xffec),	/* Offset= -20 (134) */
        0x4b,	/* FC_PP */
        0x5c,	/* FC_PAD */
        ...
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xff7a),	/* Offset= -134 (38) */
        0x5b,	/* FC_END */
        0x08,	/* FC_LONG */
        0x5c,	/* FC_PAD */
        0x5b,	/* FC_END */
/* 178 (PInterfaceList) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xffe2),	/* Offset= -30 (150) */
/* 182 (PInterfaceList *) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
        NdrFcShort(0xfffa),	/* Offset= -6 (178) */
        0x0
    }
};
