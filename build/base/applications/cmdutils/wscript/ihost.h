/*** Autogenerated by WIDL <undefined version> from ihost.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IArguments2_QueryInterface(IArguments2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IArguments2_AddRef(IArguments2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IArguments2_Release(IArguments2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IArguments2_GetTypeInfoCount(IArguments2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IArguments2_GetTypeInfo(IArguments2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IArguments2_GetIDsOfNames(IArguments2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IArguments2_Invoke(IArguments2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IArguments2 methods ***/
static inline HRESULT IArguments2_Item(IArguments2* This,LONG Index,BSTR *out_Value) {
    return This->lpVtbl->Item(This,Index,out_Value);
}
static inline HRESULT IArguments2_Count(IArguments2* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static inline HRESULT IArguments2_get_length(IArguments2* This,LONG *out_Count) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITextStream_QueryInterface(ITextStream* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITextStream_AddRef(ITextStream* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITextStream_Release(ITextStream* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT ITextStream_GetTypeInfoCount(ITextStream* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT ITextStream_GetTypeInfo(ITextStream* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT ITextStream_GetIDsOfNames(ITextStream* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT ITextStream_Invoke(ITextStream* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** ITextStream methods ***/
static inline HRESULT ITextStream_get_Line(ITextStream* This,LONG *Line) {
    return This->lpVtbl->get_Line(This,Line);
}
static inline HRESULT ITextStream_get_Column(ITextStream* This,LONG *Column) {
    return This->lpVtbl->get_Column(This,Column);
}
static inline HRESULT ITextStream_get_AtEndOfStream(ITextStream* This,VARIANT_BOOL *EOS) {
    return This->lpVtbl->get_AtEndOfStream(This,EOS);
}
static inline HRESULT ITextStream_get_AtEndOfLine(ITextStream* This,VARIANT_BOOL *EOL) {
    return This->lpVtbl->get_AtEndOfLine(This,EOL);
}
static inline HRESULT ITextStream_Read(ITextStream* This,LONG Characters,BSTR *Text) {
    return This->lpVtbl->Read(This,Characters,Text);
}
static inline HRESULT ITextStream_ReadLine(ITextStream* This,BSTR *Text) {
    return This->lpVtbl->ReadLine(This,Text);
}
static inline HRESULT ITextStream_ReadAll(ITextStream* This,BSTR *Text) {
    return This->lpVtbl->ReadAll(This,Text);
}
static inline HRESULT ITextStream_Write(ITextStream* This,BSTR Text) {
    return This->lpVtbl->Write(This,Text);
}
static inline HRESULT ITextStream_WriteLine(ITextStream* This,BSTR Text) {
    return This->lpVtbl->WriteLine(This,Text);
}
static inline HRESULT ITextStream_WriteBlankLines(ITextStream* This,LONG Lines) {
    return This->lpVtbl->WriteBlankLines(This,Lines);
}
static inline HRESULT ITextStream_Skip(ITextStream* This,LONG Characters) {
    return This->lpVtbl->Skip(This,Characters);
}
static inline HRESULT ITextStream_SkipLine(ITextStream* This) {
    return This->lpVtbl->SkipLine(This);
}
static inline HRESULT ITextStream_Close(ITextStream* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IHost_QueryInterface(IHost* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IHost_AddRef(IHost* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IHost_Release(IHost* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IHost_GetTypeInfoCount(IHost* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IHost_GetTypeInfo(IHost* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IHost_GetIDsOfNames(IHost* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IHost_Invoke(IHost* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IHost methods ***/
static inline HRESULT IHost_get_Name(IHost* This,BSTR *out_Name) {
    return This->lpVtbl->get_Name(This,out_Name);
}
static inline HRESULT IHost_get_Application(IHost* This,IDispatch **out_Dispatch) {
    return This->lpVtbl->get_Application(This,out_Dispatch);
}
static inline HRESULT IHost_get_FullName(IHost* This,BSTR *out_Path) {
    return This->lpVtbl->get_FullName(This,out_Path);
}
static inline HRESULT IHost_get_Path(IHost* This,BSTR *out_Path) {
    return This->lpVtbl->get_Path(This,out_Path);
}
static inline HRESULT IHost_get_Interactive(IHost* This,VARIANT_BOOL *out_Interactive) {
    return This->lpVtbl->get_Interactive(This,out_Interactive);
}
static inline HRESULT IHost_put_Interactive(IHost* This,VARIANT_BOOL out_Interactive) {
    return This->lpVtbl->put_Interactive(This,out_Interactive);
}
static inline HRESULT IHost_Quit(IHost* This,int ExitCode) {
    return This->lpVtbl->Quit(This,ExitCode);
}
static inline HRESULT IHost_get_ScriptName(IHost* This,BSTR *out_ScriptName) {
    return This->lpVtbl->get_ScriptName(This,out_ScriptName);
}
static inline HRESULT IHost_get_ScriptFullName(IHost* This,BSTR *out_ScriptFullName) {
    return This->lpVtbl->get_ScriptFullName(This,out_ScriptFullName);
}
static inline HRESULT IHost_get_Arguments(IHost* This,IArguments2 **out_Arguments) {
    return This->lpVtbl->get_Arguments(This,out_Arguments);
}
static inline HRESULT IHost_get_Version(IHost* This,BSTR *out_Version) {
    return This->lpVtbl->get_Version(This,out_Version);
}
static inline HRESULT IHost_get_BuildVersion(IHost* This,int *out_Build) {
    return This->lpVtbl->get_BuildVersion(This,out_Build);
}
static inline HRESULT IHost_get_Timeout(IHost* This,LONG *out_Timeout) {
    return This->lpVtbl->get_Timeout(This,out_Timeout);
}
static inline HRESULT IHost_put_Timeout(IHost* This,LONG out_Timeout) {
    return This->lpVtbl->put_Timeout(This,out_Timeout);
}
static inline HRESULT IHost_CreateObject(IHost* This,BSTR ProgID,BSTR Prefix,IDispatch **out_Dispatch) {
    return This->lpVtbl->CreateObject(This,ProgID,Prefix,out_Dispatch);
}
static inline HRESULT IHost_Echo(IHost* This,SAFEARRAY *pArgs) {
    return This->lpVtbl->Echo(This,pArgs);
}
static inline HRESULT IHost_GetObject(IHost* This,BSTR Pathname,BSTR ProgID,BSTR Prefix,IDispatch **out_Dispatch) {
    return This->lpVtbl->GetObject(This,Pathname,ProgID,Prefix,out_Dispatch);
}
static inline HRESULT IHost_DisconnectObject(IHost* This,IDispatch *Object) {
    return This->lpVtbl->DisconnectObject(This,Object);
}
static inline HRESULT IHost_Sleep(IHost* This,LONG Time) {
    return This->lpVtbl->Sleep(This,Time);
}
static inline HRESULT IHost_ConnectObject(IHost* This,IDispatch *Object,BSTR Prefix) {
    return This->lpVtbl->ConnectObject(This,Object,Prefix);
}
static inline HRESULT IHost_get_StdIn(IHost* This,ITextStream **out_ppts) {
    return This->lpVtbl->get_StdIn(This,out_ppts);
}
static inline HRESULT IHost_get_StdOut(IHost* This,ITextStream **ppts) {
    return This->lpVtbl->get_StdOut(This,ppts);
}
static inline HRESULT IHost_get_StdErr(IHost* This,ITextStream **ppts) {
