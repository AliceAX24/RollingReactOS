...
typedef enum __WIDL_ctffunc_generated_name_0000001C {
    STYLE_ACTIVE_SELECTION = 0,
    STYLE_IMPLIED_SELECTION = 0x1
} TfIntegratableCandidateListSelectionStyle;
typedef enum __WIDL_ctffunc_generated_name_0000001D {
    GETIF_RESMGR = 0,
...
/*** IEnumTfCandidates methods ***/
static inline HRESULT IEnumTfCandidates_Clone(IEnumTfCandidates* This,IEnumTfCandidates **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
static inline HRESULT IEnumTfCandidates_Next(IEnumTfCandidates* This,ULONG ulCount,ITfCandidateString **ppCand,ULONG *pcFetched) {
...
static inline HRESULT IEnumTfCandidates_Skip(IEnumTfCandidates* This,ULONG ulCount) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumTfLatticeElements_QueryInterface(IEnumTfLatticeElements* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEnumTfLatticeElements_AddRef(IEnumTfLatticeElements* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEnumTfLatticeElements_Release(IEnumTfLatticeElements* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumTfLatticeElements methods ***/
static inline HRESULT IEnumTfLatticeElements_Clone(IEnumTfLatticeElements* This,IEnumTfLatticeElements **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
static inline HRESULT IEnumTfLatticeElements_Next(IEnumTfLatticeElements* This,ULONG ulCount,TF_LMLATTELEMENT *rgsElements,ULONG *pcFetched) {
    return This->lpVtbl->Next(This,ulCount,rgsElements,pcFetched);
}
static inline HRESULT IEnumTfLatticeElements_Reset(IEnumTfLatticeElements* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IEnumTfLatticeElements_Skip(IEnumTfLatticeElements* This,ULONG ulCount) {
    return This->lpVtbl->Skip(This,ulCount);
}
#endif
#endif
...
/*** ITfCandidateList methods ***/
static inline HRESULT ITfCandidateList_EnumCandidates(ITfCandidateList* This,IEnumTfCandidates **ppEnum) {
    return This->lpVtbl->EnumCandidates(This,ppEnum);
}
static inline HRESULT ITfCandidateList_GetCandidate(ITfCandidateList* This,ULONG nIndex,ITfCandidateString **ppCand) {
    return This->lpVtbl->GetCandidate(This,nIndex,ppCand);
}
static inline HRESULT ITfCandidateList_GetCandidateNum(ITfCandidateList* This,ULONG *pnCnt) {
...
/*** ITfCandidateString methods ***/
static inline HRESULT ITfCandidateString_GetString(ITfCandidateString* This,BSTR *pbstr) {
    return This->lpVtbl->GetString(This,pbstr);
}
static inline HRESULT ITfCandidateString_GetIndex(ITfCandidateString* This,ULONG *pnIndex) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnAdviseText_QueryInterface(ITfFnAdviseText* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnAdviseText_AddRef(ITfFnAdviseText* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnAdviseText_Release(ITfFnAdviseText* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnAdviseText methods ***/
static inline HRESULT ITfFnAdviseText_OnTextUpdate(ITfFnAdviseText* This,ITfRange *pRange,const WCHAR *pchText,LONG cch) {
    return This->lpVtbl->OnTextUpdate(This,pRange,pchText,cch);
}
static inline HRESULT ITfFnAdviseText_OnLatticeUpdate(ITfFnAdviseText* This,ITfRange *pRange,ITfLMLattice *pLattice) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnBalloon_QueryInterface(ITfFnBalloon* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnBalloon_AddRef(ITfFnBalloon* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnBalloon_Release(ITfFnBalloon* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnBalloon methods ***/
static inline HRESULT ITfFnBalloon_UpdateBalloon(ITfFnBalloon* This,TfLBBalloonStyle style,const WCHAR *pch,ULONG cch) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnConfigure_QueryInterface(ITfFnConfigure* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnConfigure_AddRef(ITfFnConfigure* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnConfigure_Release(ITfFnConfigure* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnConfigure methods ***/
static inline HRESULT ITfFnConfigure_Show(ITfFnConfigure* This,HWND hwndParent,LANGID langid,REFGUID rguidProfile) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnConfigureRegisterEudc_QueryInterface(ITfFnConfigureRegisterEudc* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnConfigureRegisterEudc_AddRef(ITfFnConfigureRegisterEudc* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnConfigureRegisterEudc_Release(ITfFnConfigureRegisterEudc* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnConfigureRegisterEudc methods ***/
static inline HRESULT ITfFnConfigureRegisterEudc_Show(ITfFnConfigureRegisterEudc* This,HWND hwndParent,LANGID langid,REFGUID rguidProfile,BSTR bstrRegistered) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnConfigureRegisterWord_QueryInterface(ITfFnConfigureRegisterWord* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnConfigureRegisterWord_AddRef(ITfFnConfigureRegisterWord* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnConfigureRegisterWord_Release(ITfFnConfigureRegisterWord* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnConfigureRegisterWord methods ***/
static inline HRESULT ITfFnConfigureRegisterWord_Show(ITfFnConfigureRegisterWord* This,HWND hwndParent,LANGID langid,REFGUID rguidProfile,BSTR bstrRegistered) {
    return This->lpVtbl->Show(This,hwndParent,langid,rguidProfile,bstrRegistered);
}
#endif
#endif
...
/*** ITfFunction methods ***/
static inline HRESULT ITfFunction_GetDisplayName(ITfFunction* This,BSTR *pbstrName) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnGetLinguisticAlternates_QueryInterface(ITfFnGetLinguisticAlternates* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnGetLinguisticAlternates_AddRef(ITfFnGetLinguisticAlternates* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnGetLinguisticAlternates_Release(ITfFnGetLinguisticAlternates* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFunction methods ***/
static inline HRESULT ITfFnGetLinguisticAlternates_GetDisplayName(ITfFnGetLinguisticAlternates* This,BSTR *pbstrName) {
    return This->lpVtbl->GetDisplayName(This,pbstrName);
}
/*** ITfFnGetLinguisticAlternates methods ***/
static inline HRESULT ITfFnGetLinguisticAlternates_GetAlternates(ITfFnGetLinguisticAlternates* This,ITfRange *pRange,ITfCandidateList **ppCandidateList) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnGetPreferredTouchKeyboardLayout_QueryInterface(ITfFnGetPreferredTouchKeyboardLayout* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnGetPreferredTouchKeyboardLayout_AddRef(ITfFnGetPreferredTouchKeyboardLayout* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnGetPreferredTouchKeyboardLayout_Release(ITfFnGetPreferredTouchKeyboardLayout* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFunction methods ***/
static inline HRESULT ITfFnGetPreferredTouchKeyboardLayout_GetDisplayName(ITfFnGetPreferredTouchKeyboardLayout* This,BSTR *pbstrName) {
    return This->lpVtbl->GetDisplayName(This,pbstrName);
}
/*** ITfFnGetPreferredTouchKeyboardLayout methods ***/
static inline HRESULT ITfFnGetPreferredTouchKeyboardLayout_GetLayout(ITfFnGetPreferredTouchKeyboardLayout* This,TKBLayoutType *pTKBLayoutType,WORD *pwPreferredLayoutId) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnGetSAPIObject_QueryInterface(ITfFnGetSAPIObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnGetSAPIObject_AddRef(ITfFnGetSAPIObject* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnGetSAPIObject_Release(ITfFnGetSAPIObject* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnGetSAPIObject methods ***/
static inline HRESULT ITfFnGetSAPIObject_Get(ITfFnGetSAPIObject* This,TfSapiObject sObj,IUnknown **ppunk) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnLMInternal_QueryInterface(ITfFnLMInternal* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnLMInternal_AddRef(ITfFnLMInternal* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnLMInternal_Release(ITfFnLMInternal* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnLMInternal methods ***/
static inline HRESULT ITfFnLMInternal_ProcessLattice(ITfFnLMInternal* This,ITfRange *pRange) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnLMProcessor_QueryInterface(ITfFnLMProcessor* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnLMProcessor_AddRef(ITfFnLMProcessor* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnLMProcessor_Release(ITfFnLMProcessor* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnLMProcessor methods ***/
static inline HRESULT ITfFnLMProcessor_QueryRange(ITfFnLMProcessor* This,ITfRange *pRange,ITfRange **ppNewRange,BOOL *pfAccepted) {
    return This->lpVtbl->QueryRange(This,pRange,ppNewRange,pfAccepted);
}
static inline HRESULT ITfFnLMProcessor_QueryLangID(ITfFnLMProcessor* This,LANGID langid,BOOL *pfAccepted) {
    return This->lpVtbl->QueryLangID(This,langid,pfAccepted);
}
static inline HRESULT ITfFnLMProcessor_GetReconversion(ITfFnLMProcessor* This,ITfRange *pRange,ITfCandidateList **ppCandList) {
    return This->lpVtbl->GetReconversion(This,pRange,ppCandList);
}
static inline HRESULT ITfFnLMProcessor_Reconvert(ITfFnLMProcessor* This,ITfRange *pRange) {
    return This->lpVtbl->Reconvert(This,pRange);
}
static inline HRESULT ITfFnLMProcessor_QueryKey(ITfFnLMProcessor* This,BOOL fUp,WPARAM vKey,LPARAM lparamKeydata,BOOL *pfInterested) {
    return This->lpVtbl->QueryKey(This,fUp,vKey,lparamKeydata,pfInterested);
}
static inline HRESULT ITfFnLMProcessor_InvokeKey(ITfFnLMProcessor* This,BOOL fUp,WPARAM vKey,LPARAM lparamKeyData) {
    return This->lpVtbl->InvokeKey(This,fUp,vKey,lparamKeyData);
}
static inline HRESULT ITfFnLMProcessor_InvokeFunc(ITfFnLMProcessor* This,ITfContext *pic,REFGUID refguidFunc) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnLangProfileUtil_QueryInterface(ITfFnLangProfileUtil* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnLangProfileUtil_AddRef(ITfFnLangProfileUtil* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnLangProfileUtil_Release(ITfFnLangProfileUtil* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnLangProfileUtil methods ***/
static inline HRESULT ITfFnLangProfileUtil_RegisterActiveProfiles(ITfFnLangProfileUtil* This) {
    return This->lpVtbl->RegisterActiveProfiles(This);
}
static inline HRESULT ITfFnLangProfileUtil_IsProfileAvailableForLang(ITfFnLangProfileUtil* This,LANGID langid,BOOL *pfAvailable) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnPlayBack_QueryInterface(ITfFnPlayBack* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnPlayBack_AddRef(ITfFnPlayBack* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnPlayBack_Release(ITfFnPlayBack* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnPlayBack methods ***/
static inline HRESULT ITfFnPlayBack_QueryRange(ITfFnPlayBack* This,ITfRange *pRange,ITfRange **ppNewRange,BOOL *pfPlayable) {
    return This->lpVtbl->QueryRange(This,pRange,ppNewRange,pfPlayable);
}
static inline HRESULT ITfFnPlayBack_Play(ITfFnPlayBack* This,ITfRange *pRange) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnPropertyUIStatus_QueryInterface(ITfFnPropertyUIStatus* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnPropertyUIStatus_AddRef(ITfFnPropertyUIStatus* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnPropertyUIStatus_Release(ITfFnPropertyUIStatus* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnPropertyUIStatus methods ***/
static inline HRESULT ITfFnPropertyUIStatus_GetStatus(ITfFnPropertyUIStatus* This,REFGUID refguidProp,DWORD *pdw) {
    return This->lpVtbl->GetStatus(This,refguidProp,pdw);
}
static inline HRESULT ITfFnPropertyUIStatus_SetStatus(ITfFnPropertyUIStatus* This,REFGUID refguidProp,DWORD dw) {
...
/*** ITfFnReconversion methods ***/
static inline HRESULT ITfFnReconversion_QueryRange(ITfFnReconversion* This,ITfRange *pRange,ITfRange **ppNewRange,BOOL *pfConvertable) {
    return This->lpVtbl->QueryRange(This,pRange,ppNewRange,pfConvertable);
}
static inline HRESULT ITfFnReconversion_GetReconversion(ITfFnReconversion* This,ITfRange *pRange,ITfCandidateList **ppCandList) {
    return This->lpVtbl->GetReconversion(This,pRange,ppCandList);
}
static inline HRESULT ITfFnReconversion_Reconvert(ITfFnReconversion* This,ITfRange *pRange) {
    return This->lpVtbl->Reconvert(This,pRange);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnSearchCandidateProvider_QueryInterface(ITfFnSearchCandidateProvider* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnSearchCandidateProvider_AddRef(ITfFnSearchCandidateProvider* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnSearchCandidateProvider_Release(ITfFnSearchCandidateProvider* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnSearchCandidateProvider methods ***/
static inline HRESULT ITfFnSearchCandidateProvider_GetSearchCandidates(ITfFnSearchCandidateProvider* This,BSTR bstrQuery,BSTR bstrApplicationId,ITfCandidateList **pplist) {
    return This->lpVtbl->GetSearchCandidates(This,bstrQuery,bstrApplicationId,pplist);
}
static inline HRESULT ITfFnSearchCandidateProvider_SetResult(ITfFnSearchCandidateProvider* This,BSTR bstrQuery,BSTR bstrApplicationID,BSTR bstrResult) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfFnShowHelp_QueryInterface(ITfFnShowHelp* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfFnShowHelp_AddRef(ITfFnShowHelp* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfFnShowHelp_Release(ITfFnShowHelp* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfFnShowHelp methods ***/
static inline HRESULT ITfFnShowHelp_Show(ITfFnShowHelp* This,HWND hwndParent) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfIntegratableCandidateListUIElement_QueryInterface(ITfIntegratableCandidateListUIElement* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfIntegratableCandidateListUIElement_AddRef(ITfIntegratableCandidateListUIElement* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfIntegratableCandidateListUIElement_Release(ITfIntegratableCandidateListUIElement* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfIntegratableCandidateListUIElement methods ***/
static inline HRESULT ITfIntegratableCandidateListUIElement_SetIntegrationStyle(ITfIntegratableCandidateListUIElement* This,GUID guidIntegrationStyle) {
    return This->lpVtbl->SetIntegrationStyle(This,guidIntegrationStyle);
}
static inline HRESULT ITfIntegratableCandidateListUIElement_GetSelectionStyle(ITfIntegratableCandidateListUIElement* This,TfIntegratableCandidateListSelectionStyle *ptfSelectionStyle) {
    return This->lpVtbl->GetSelectionStyle(This,ptfSelectionStyle);
}
static inline HRESULT ITfIntegratableCandidateListUIElement_OnKeyDown(ITfIntegratableCandidateListUIElement* This,WPARAM wParam,LPARAM lParam,BOOL *pfEaten) {
    return This->lpVtbl->OnKeyDown(This,wParam,lParam,pfEaten);
}
static inline HRESULT ITfIntegratableCandidateListUIElement_ShowCandidateNumbers(ITfIntegratableCandidateListUIElement* This,BOOL *pfShow) {
    return This->lpVtbl->ShowCandidateNumbers(This,pfShow);
}
static inline HRESULT ITfIntegratableCandidateListUIElement_FinalizeExactCompositionString(ITfIntegratableCandidateListUIElement* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfLMLattice_QueryInterface(ITfLMLattice* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfLMLattice_AddRef(ITfLMLattice* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfLMLattice_Release(ITfLMLattice* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfLMLattice methods ***/
static inline HRESULT ITfLMLattice_QueryType(ITfLMLattice* This,REFGUID rguidType,BOOL *pfSupported) {
    return This->lpVtbl->QueryType(This,rguidType,pfSupported);
}
static inline HRESULT ITfLMLattice_EnumLatticeElements(ITfLMLattice* This,DWORD dwFrameStart,REFGUID rguidType,IEnumTfLatticeElements **ppEnum) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUIManagerEventSink_QueryInterface(IUIManagerEventSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IUIManagerEventSink_AddRef(IUIManagerEventSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IUIManagerEventSink_Release(IUIManagerEventSink* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIManagerEventSink methods ***/
static inline HRESULT IUIManagerEventSink_OnWindowOpening(IUIManagerEventSink* This,RECT *prcBounds) {
    return This->lpVtbl->OnWindowOpening(This,prcBounds);
}
static inline HRESULT IUIManagerEventSink_OnWindowOpened(IUIManagerEventSink* This,RECT *prcBounds) {
    return This->lpVtbl->OnWindowOpened(This,prcBounds);
}
static inline HRESULT IUIManagerEventSink_OnWindowUpdating(IUIManagerEventSink* This,RECT *prcUpdatedBounds) {
    return This->lpVtbl->OnWindowUpdating(This,prcUpdatedBounds);
}
static inline HRESULT IUIManagerEventSink_OnWindowUpdated(IUIManagerEventSink* This,RECT *prcUpdatedBounds) {
    return This->lpVtbl->OnWindowUpdated(This,prcUpdatedBounds);
}
static inline HRESULT IUIManagerEventSink_OnWindowClosing(IUIManagerEventSink* This) {
    return This->lpVtbl->OnWindowClosing(This);
}
static inline HRESULT IUIManagerEventSink_OnWindowClosed(IUIManagerEventSink* This) {
