...
#else
/*** IUnknown methods ***/
static inline HRESULT IEmptyVolumeCacheCallBack_QueryInterface(IEmptyVolumeCacheCallBack* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEmptyVolumeCacheCallBack_AddRef(IEmptyVolumeCacheCallBack* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEmptyVolumeCacheCallBack_Release(IEmptyVolumeCacheCallBack* This) {
    return This->lpVtbl->Release(This);
}
/*** IEmptyVolumeCacheCallBack methods ***/
static inline HRESULT IEmptyVolumeCacheCallBack_ScanProgress(IEmptyVolumeCacheCallBack* This,DWORDLONG dwlSpaceUsed,DWORD dwFlags,LPCWSTR pcwszStatus) {
    return This->lpVtbl->ScanProgress(This,dwlSpaceUsed,dwFlags,pcwszStatus);
}
static inline HRESULT IEmptyVolumeCacheCallBack_PurgeProgress(IEmptyVolumeCacheCallBack* This,DWORDLONG dwlSpaceFreed,DWORDLONG dwlSpaceToFree,DWORD dwFlags,LPCWSTR pcwszStatus) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEmptyVolumeCache_QueryInterface(IEmptyVolumeCache* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEmptyVolumeCache_AddRef(IEmptyVolumeCache* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEmptyVolumeCache_Release(IEmptyVolumeCache* This) {
    return This->lpVtbl->Release(This);
}
/*** IEmptyVolumeCache methods ***/
static inline HRESULT IEmptyVolumeCache_Initialize(IEmptyVolumeCache* This,HKEY hkRegKey,LPCWSTR pcwszVolume,LPWSTR *ppwszDisplayName,LPWSTR *ppwszDescription,DWORD *pdwFlags) {
    return This->lpVtbl->Initialize(This,hkRegKey,pcwszVolume,ppwszDisplayName,ppwszDescription,pdwFlags);
}
static inline HRESULT IEmptyVolumeCache_GetSpaceUsed(IEmptyVolumeCache* This,DWORDLONG *pdwlSpaceUsed,IEmptyVolumeCacheCallBack *picb) {
    return This->lpVtbl->GetSpaceUsed(This,pdwlSpaceUsed,picb);
}
static inline HRESULT IEmptyVolumeCache_Purge(IEmptyVolumeCache* This,DWORDLONG dwlSpaceToFree,IEmptyVolumeCacheCallBack *picb) {
    return This->lpVtbl->Purge(This,dwlSpaceToFree,picb);
}
static inline HRESULT IEmptyVolumeCache_ShowProperties(IEmptyVolumeCache* This,HWND hwnd) {
    return This->lpVtbl->ShowProperties(This,hwnd);
}
static inline HRESULT IEmptyVolumeCache_Deactivate(IEmptyVolumeCache* This,DWORD *pdwFlags) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEmptyVolumeCache2_QueryInterface(IEmptyVolumeCache2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEmptyVolumeCache2_AddRef(IEmptyVolumeCache2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEmptyVolumeCache2_Release(IEmptyVolumeCache2* This) {
    return This->lpVtbl->Release(This);
}
/*** IEmptyVolumeCache methods ***/
static inline HRESULT IEmptyVolumeCache2_Initialize(IEmptyVolumeCache2* This,HKEY hkRegKey,LPCWSTR pcwszVolume,LPWSTR *ppwszDisplayName,LPWSTR *ppwszDescription,DWORD *pdwFlags) {
    return This->lpVtbl->Initialize(This,hkRegKey,pcwszVolume,ppwszDisplayName,ppwszDescription,pdwFlags);
}
static inline HRESULT IEmptyVolumeCache2_GetSpaceUsed(IEmptyVolumeCache2* This,DWORDLONG *pdwlSpaceUsed,IEmptyVolumeCacheCallBack *picb) {
    return This->lpVtbl->GetSpaceUsed(This,pdwlSpaceUsed,picb);
}
static inline HRESULT IEmptyVolumeCache2_Purge(IEmptyVolumeCache2* This,DWORDLONG dwlSpaceToFree,IEmptyVolumeCacheCallBack *picb) {
    return This->lpVtbl->Purge(This,dwlSpaceToFree,picb);
}
static inline HRESULT IEmptyVolumeCache2_ShowProperties(IEmptyVolumeCache2* This,HWND hwnd) {
    return This->lpVtbl->ShowProperties(This,hwnd);
}
static inline HRESULT IEmptyVolumeCache2_Deactivate(IEmptyVolumeCache2* This,DWORD *pdwFlags) {
    return This->lpVtbl->Deactivate(This,pdwFlags);
}
/*** IEmptyVolumeCache2 methods ***/
static inline HRESULT IEmptyVolumeCache2_InitializeEx(IEmptyVolumeCache2* This,HKEY hkRegKey,LPCWSTR pcwszVolume,LPCWSTR pcwszKeyName,LPWSTR *ppwszDisplayName,LPWSTR *ppwszDescription,LPWSTR *ppwszBtnText,DWORD *pdwFlags) {
