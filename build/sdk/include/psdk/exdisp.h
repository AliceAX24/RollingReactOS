...
#else
/*** IUnknown methods ***/
static inline HRESULT DSearchCommandEvents_QueryInterface(DSearchCommandEvents* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG DSearchCommandEvents_AddRef(DSearchCommandEvents* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG DSearchCommandEvents_Release(DSearchCommandEvents* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT DSearchCommandEvents_GetTypeInfoCount(DSearchCommandEvents* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT DSearchCommandEvents_GetTypeInfo(DSearchCommandEvents* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT DSearchCommandEvents_GetIDsOfNames(DSearchCommandEvents* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT DSearchCommandEvents_Invoke(DSearchCommandEvents* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
