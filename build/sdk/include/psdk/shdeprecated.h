...
static inline HRESULT ITravelEntry_GetPidl(ITravelEntry* This,PIDLIST_ABSOLUTE *ppidl) {
...
static inline HRESULT ITravelLog_FindTravelEntry(ITravelLog* This,IUnknown *punk,PCIDLIST_ABSOLUTE pidl,ITravelEntry **ppte) {
...
static inline HRESULT IBrowserService2__NavigateToPidl(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
static inline HRESULT IBrowserService2__TryShell2Rename(IBrowserService2* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
...
static inline IStream * IBrowserService2_v_GetViewStream(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
...
static inline HRESULT IBrowserService2_v_CheckZoneCrossing(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBrowserService3_QueryInterface(IBrowserService3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBrowserService3_AddRef(IBrowserService3* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBrowserService3_Release(IBrowserService3* This) {
    return This->lpVtbl->Release(This);
}
/*** IBrowserService methods ***/
static inline HRESULT IBrowserService3_GetParentSite(IBrowserService3* This,IOleInPlaceSite **ppipsite) {
    return This->lpVtbl->GetParentSite(This,ppipsite);
}
static inline HRESULT IBrowserService3_SetTitle(IBrowserService3* This,IShellView *psv,LPCWSTR pszName) {
    return This->lpVtbl->SetTitle(This,psv,pszName);
}
static inline HRESULT IBrowserService3_GetTitle(IBrowserService3* This,IShellView *psv,LPWSTR pszName,DWORD cchName) {
    return This->lpVtbl->GetTitle(This,psv,pszName,cchName);
}
static inline HRESULT IBrowserService3_GetOleObject(IBrowserService3* This,IOleObject **ppobjv) {
    return This->lpVtbl->GetOleObject(This,ppobjv);
}
static inline HRESULT IBrowserService3_GetTravelLog(IBrowserService3* This,ITravelLog **pptl) {
    return This->lpVtbl->GetTravelLog(This,pptl);
}
static inline HRESULT IBrowserService3_ShowControlWindow(IBrowserService3* This,UINT id,BOOL fShow) {
    return This->lpVtbl->ShowControlWindow(This,id,fShow);
}
static inline HRESULT IBrowserService3_IsControlWindowShown(IBrowserService3* This,UINT id,BOOL *pfShown) {
    return This->lpVtbl->IsControlWindowShown(This,id,pfShown);
}
static inline HRESULT IBrowserService3_IEGetDisplayName(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,LPWSTR pwszName,UINT uFlags) {
    return This->lpVtbl->IEGetDisplayName(This,pidl,pwszName,uFlags);
}
static inline HRESULT IBrowserService3_IEParseDisplayName(IBrowserService3* This,UINT uiCP,LPCWSTR pwszPath,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayName(This,uiCP,pwszPath,ppidlOut);
}
static inline HRESULT IBrowserService3_DisplayParseError(IBrowserService3* This,HRESULT hres,LPCWSTR pwszPath) {
    return This->lpVtbl->DisplayParseError(This,hres,pwszPath);
}
static inline HRESULT IBrowserService3_NavigateToPidl(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF) {
    return This->lpVtbl->NavigateToPidl(This,pidl,grfHLNF);
}
static inline HRESULT IBrowserService3_SetNavigateState(IBrowserService3* This,BNSTATE bnstate) {
    return This->lpVtbl->SetNavigateState(This,bnstate);
}
static inline HRESULT IBrowserService3_GetNavigateState(IBrowserService3* This,BNSTATE *pbnstate) {
    return This->lpVtbl->GetNavigateState(This,pbnstate);
}
static inline HRESULT IBrowserService3_NotifyRedirect(IBrowserService3* This,IShellView *psv,PCIDLIST_ABSOLUTE pidl,BOOL *pfDidBrowse) {
    return This->lpVtbl->NotifyRedirect(This,psv,pidl,pfDidBrowse);
}
static inline HRESULT IBrowserService3_UpdateWindowList(IBrowserService3* This) {
    return This->lpVtbl->UpdateWindowList(This);
}
static inline HRESULT IBrowserService3_UpdateBackForwardState(IBrowserService3* This) {
    return This->lpVtbl->UpdateBackForwardState(This);
}
static inline HRESULT IBrowserService3_SetFlags(IBrowserService3* This,DWORD dwFlags,DWORD dwFlagMask) {
    return This->lpVtbl->SetFlags(This,dwFlags,dwFlagMask);
}
static inline HRESULT IBrowserService3_GetFlags(IBrowserService3* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IBrowserService3_CanNavigateNow(IBrowserService3* This) {
    return This->lpVtbl->CanNavigateNow(This);
}
static inline HRESULT IBrowserService3_GetPidl(IBrowserService3* This,PIDLIST_ABSOLUTE *ppidl) {
    return This->lpVtbl->GetPidl(This,ppidl);
}
static inline HRESULT IBrowserService3_SetReferrer(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->SetReferrer(This,pidl);
}
static inline DWORD IBrowserService3_GetBrowserIndex(IBrowserService3* This) {
    return This->lpVtbl->GetBrowserIndex(This);
}
static inline HRESULT IBrowserService3_GetBrowserByIndex(IBrowserService3* This,DWORD dwID,IUnknown **ppunk) {
    return This->lpVtbl->GetBrowserByIndex(This,dwID,ppunk);
}
static inline HRESULT IBrowserService3_GetHistoryObject(IBrowserService3* This,IOleObject **ppole,IStream **pstm,IBindCtx **ppbc) {
    return This->lpVtbl->GetHistoryObject(This,ppole,pstm,ppbc);
}
static inline HRESULT IBrowserService3_SetHistoryObject(IBrowserService3* This,IOleObject *pole,BOOL fIsLocalAnchor) {
    return This->lpVtbl->SetHistoryObject(This,pole,fIsLocalAnchor);
}
static inline HRESULT IBrowserService3_CacheOLEServer(IBrowserService3* This,IOleObject *pole) {
    return This->lpVtbl->CacheOLEServer(This,pole);
}
static inline HRESULT IBrowserService3_GetSetCodePage(IBrowserService3* This,VARIANT *pvarIn,VARIANT *pvarOut) {
    return This->lpVtbl->GetSetCodePage(This,pvarIn,pvarOut);
}
static inline HRESULT IBrowserService3_OnHttpEquiv(IBrowserService3* This,IShellView *psv,BOOL fDone,VARIANT *pvarargIn,VARIANT *pvarargOut) {
    return This->lpVtbl->OnHttpEquiv(This,psv,fDone,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService3_GetPalette(IBrowserService3* This,HPALETTE *hpal) {
    return This->lpVtbl->GetPalette(This,hpal);
}
static inline HRESULT IBrowserService3_RegisterWindow(IBrowserService3* This,BOOL fForceRegister,int swc) {
    return This->lpVtbl->RegisterWindow(This,fForceRegister,swc);
}
/*** IBrowserService2 methods ***/
static inline LRESULT IBrowserService3_WndProcBS(IBrowserService3* This,HWND hwnd,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->WndProcBS(This,hwnd,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService3_SetAsDefFolderSettings(IBrowserService3* This) {
    return This->lpVtbl->SetAsDefFolderSettings(This);
}
static inline HRESULT IBrowserService3_GetViewRect(IBrowserService3* This,RECT *prc) {
    return This->lpVtbl->GetViewRect(This,prc);
}
static inline HRESULT IBrowserService3_OnSize(IBrowserService3* This,WPARAM wParam) {
    return This->lpVtbl->OnSize(This,wParam);
}
static inline HRESULT IBrowserService3_OnCreate(IBrowserService3* This,struct tagCREATESTRUCTW *pcs) {
    return This->lpVtbl->OnCreate(This,pcs);
}
static inline LRESULT IBrowserService3_OnCommand(IBrowserService3* This,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->OnCommand(This,wParam,lParam);
}
static inline HRESULT IBrowserService3_OnDestroy(IBrowserService3* This) {
    return This->lpVtbl->OnDestroy(This);
}
static inline LRESULT IBrowserService3_OnNotify(IBrowserService3* This,struct tagNMHDR *pnm) {
    return This->lpVtbl->OnNotify(This,pnm);
}
static inline HRESULT IBrowserService3_OnSetFocus(IBrowserService3* This) {
    return This->lpVtbl->OnSetFocus(This);
}
static inline HRESULT IBrowserService3_OnFrameWindowActivateBS(IBrowserService3* This,BOOL fActive) {
    return This->lpVtbl->OnFrameWindowActivateBS(This,fActive);
}
static inline HRESULT IBrowserService3_ReleaseShellView(IBrowserService3* This) {
    return This->lpVtbl->ReleaseShellView(This);
}
static inline HRESULT IBrowserService3_ActivatePendingView(IBrowserService3* This) {
    return This->lpVtbl->ActivatePendingView(This);
}
static inline HRESULT IBrowserService3_CreateViewWindow(IBrowserService3* This,IShellView *psvNew,IShellView *psvOld,LPRECT prcView,HWND *phwnd) {
    return This->lpVtbl->CreateViewWindow(This,psvNew,psvOld,prcView,phwnd);
}
static inline HRESULT IBrowserService3_CreateBrowserPropSheetExt(IBrowserService3* This,REFIID riid,void **ppv) {
    return This->lpVtbl->CreateBrowserPropSheetExt(This,riid,ppv);
}
static inline HRESULT IBrowserService3_GetViewWindow(IBrowserService3* This,HWND *phwndView) {
    return This->lpVtbl->GetViewWindow(This,phwndView);
}
static inline HRESULT IBrowserService3_GetBaseBrowserData(IBrowserService3* This,LPCBASEBROWSERDATA *pbbd) {
    return This->lpVtbl->GetBaseBrowserData(This,pbbd);
}
static inline LPBASEBROWSERDATA IBrowserService3_PutBaseBrowserData(IBrowserService3* This) {
    return This->lpVtbl->PutBaseBrowserData(This);
}
static inline HRESULT IBrowserService3_InitializeTravelLog(IBrowserService3* This,ITravelLog *ptl,DWORD dw) {
    return This->lpVtbl->InitializeTravelLog(This,ptl,dw);
}
static inline HRESULT IBrowserService3_SetTopBrowser(IBrowserService3* This) {
    return This->lpVtbl->SetTopBrowser(This);
}
static inline HRESULT IBrowserService3_Offline(IBrowserService3* This,int iCmd) {
    return This->lpVtbl->Offline(This,iCmd);
}
static inline HRESULT IBrowserService3_AllowViewResize(IBrowserService3* This,BOOL f) {
    return This->lpVtbl->AllowViewResize(This,f);
}
static inline HRESULT IBrowserService3_SetActivateState(IBrowserService3* This,UINT u) {
    return This->lpVtbl->SetActivateState(This,u);
}
static inline HRESULT IBrowserService3_UpdateSecureLockIcon(IBrowserService3* This,int eSecureLock) {
    return This->lpVtbl->UpdateSecureLockIcon(This,eSecureLock);
}
static inline HRESULT IBrowserService3_InitializeDownloadManager(IBrowserService3* This) {
    return This->lpVtbl->InitializeDownloadManager(This);
}
static inline HRESULT IBrowserService3_InitializeTransitionSite(IBrowserService3* This) {
    return This->lpVtbl->InitializeTransitionSite(This);
}
static inline HRESULT IBrowserService3__Initialize(IBrowserService3* This,HWND hwnd,IUnknown *pauto) {
    return This->lpVtbl->_Initialize(This,hwnd,pauto);
}
static inline HRESULT IBrowserService3__CancelPendingNavigationAsync(IBrowserService3* This) {
    return This->lpVtbl->_CancelPendingNavigationAsync(This);
}
static inline HRESULT IBrowserService3__CancelPendingView(IBrowserService3* This) {
    return This->lpVtbl->_CancelPendingView(This);
}
static inline HRESULT IBrowserService3__MaySaveChanges(IBrowserService3* This) {
    return This->lpVtbl->_MaySaveChanges(This);
}
static inline HRESULT IBrowserService3__PauseOrResumeView(IBrowserService3* This,BOOL fPaused) {
    return This->lpVtbl->_PauseOrResumeView(This,fPaused);
}
static inline HRESULT IBrowserService3__DisableModeless(IBrowserService3* This) {
    return This->lpVtbl->_DisableModeless(This);
}
static inline HRESULT IBrowserService3__NavigateToPidl(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
static inline HRESULT IBrowserService3__TryShell2Rename(IBrowserService3* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
    return This->lpVtbl->_TryShell2Rename(This,psv,pidlNew);
}
static inline HRESULT IBrowserService3__SwitchActivationNow(IBrowserService3* This) {
    return This->lpVtbl->_SwitchActivationNow(This);
}
static inline HRESULT IBrowserService3__ExecChildren(IBrowserService3* This,IUnknown *punkBar,BOOL fBroadcast,const GUID *pguidCmdGroup,DWORD nCmdID,DWORD nCmdexecopt,VARIANTARG *pvarargIn,VARIANTARG *pvarargOut) {
    return This->lpVtbl->_ExecChildren(This,punkBar,fBroadcast,pguidCmdGroup,nCmdID,nCmdexecopt,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService3__SendChildren(IBrowserService3* This,HWND hwndBar,BOOL fBroadcast,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->_SendChildren(This,hwndBar,fBroadcast,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService3_GetFolderSetData(IBrowserService3* This,struct tagFolderSetData *pfsd) {
    return This->lpVtbl->GetFolderSetData(This,pfsd);
}
static inline HRESULT IBrowserService3__OnFocusChange(IBrowserService3* This,UINT itb) {
    return This->lpVtbl->_OnFocusChange(This,itb);
}
static inline HRESULT IBrowserService3_v_ShowHideChildWindows(IBrowserService3* This,BOOL fChildOnly) {
    return This->lpVtbl->v_ShowHideChildWindows(This,fChildOnly);
}
static inline UINT IBrowserService3__get_itbLastFocus(IBrowserService3* This) {
    return This->lpVtbl->_get_itbLastFocus(This);
}
static inline HRESULT IBrowserService3__put_itbLastFocus(IBrowserService3* This,UINT itbLastFocus) {
    return This->lpVtbl->_put_itbLastFocus(This,itbLastFocus);
}
static inline HRESULT IBrowserService3__UIActivateView(IBrowserService3* This,UINT uState) {
    return This->lpVtbl->_UIActivateView(This,uState);
}
static inline HRESULT IBrowserService3__GetViewBorderRect(IBrowserService3* This,RECT *prc) {
    return This->lpVtbl->_GetViewBorderRect(This,prc);
}
static inline HRESULT IBrowserService3__UpdateViewRectSize(IBrowserService3* This) {
    return This->lpVtbl->_UpdateViewRectSize(This);
}
static inline HRESULT IBrowserService3__ResizeNextBorder(IBrowserService3* This,UINT itb) {
    return This->lpVtbl->_ResizeNextBorder(This,itb);
}
static inline HRESULT IBrowserService3__ResizeView(IBrowserService3* This) {
    return This->lpVtbl->_ResizeView(This);
}
static inline HRESULT IBrowserService3__GetEffectiveClientArea(IBrowserService3* This,LPRECT lprectBorder,HMONITOR hmon) {
    return This->lpVtbl->_GetEffectiveClientArea(This,lprectBorder,hmon);
}
static inline IStream * IBrowserService3_v_GetViewStream(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
    return This->lpVtbl->v_GetViewStream(This,pidl,grfMode,pwszName);
}
static inline LRESULT IBrowserService3_ForwardViewMsg(IBrowserService3* This,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->ForwardViewMsg(This,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService3_SetAcceleratorMenu(IBrowserService3* This,HACCEL hacc) {
    return This->lpVtbl->SetAcceleratorMenu(This,hacc);
}
static inline int IBrowserService3__GetToolbarCount(IBrowserService3* This) {
    return This->lpVtbl->_GetToolbarCount(This);
}
static inline LPTOOLBARITEM IBrowserService3__GetToolbarItem(IBrowserService3* This,int itb) {
    return This->lpVtbl->_GetToolbarItem(This,itb);
}
static inline HRESULT IBrowserService3__SaveToolbars(IBrowserService3* This,IStream *pstm) {
    return This->lpVtbl->_SaveToolbars(This,pstm);
}
static inline HRESULT IBrowserService3__LoadToolbars(IBrowserService3* This,IStream *pstm) {
    return This->lpVtbl->_LoadToolbars(This,pstm);
}
static inline HRESULT IBrowserService3__CloseAndReleaseToolbars(IBrowserService3* This,BOOL fClose) {
    return This->lpVtbl->_CloseAndReleaseToolbars(This,fClose);
}
static inline HRESULT IBrowserService3_v_MayGetNextToolbarFocus(IBrowserService3* This,LPMSG lpMsg,UINT itbNext,int citb,LPTOOLBARITEM *pptbi,HWND *phwnd) {
    return This->lpVtbl->v_MayGetNextToolbarFocus(This,lpMsg,itbNext,citb,pptbi,phwnd);
}
static inline HRESULT IBrowserService3__ResizeNextBorderHelper(IBrowserService3* This,UINT itb,BOOL bUseHmonitor) {
    return This->lpVtbl->_ResizeNextBorderHelper(This,itb,bUseHmonitor);
}
static inline UINT IBrowserService3__FindTBar(IBrowserService3* This,IUnknown *punkSrc) {
    return This->lpVtbl->_FindTBar(This,punkSrc);
}
static inline HRESULT IBrowserService3__SetFocus(IBrowserService3* This,LPTOOLBARITEM ptbi,HWND hwnd,LPMSG lpMsg) {
    return This->lpVtbl->_SetFocus(This,ptbi,hwnd,lpMsg);
}
static inline HRESULT IBrowserService3_v_MayTranslateAccelerator(IBrowserService3* This,MSG *pmsg) {
    return This->lpVtbl->v_MayTranslateAccelerator(This,pmsg);
}
static inline HRESULT IBrowserService3__GetBorderDWHelper(IBrowserService3* This,IUnknown *punkSrc,LPRECT lprectBorder,BOOL bUseHmonitor) {
    return This->lpVtbl->_GetBorderDWHelper(This,punkSrc,lprectBorder,bUseHmonitor);
}
static inline HRESULT IBrowserService3_v_CheckZoneCrossing(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->v_CheckZoneCrossing(This,pidl);
}
/*** IBrowserService3 methods ***/
static inline HRESULT IBrowserService3__PositionViewWindow(IBrowserService3* This,HWND hwnd,LPRECT prc) {
    return This->lpVtbl->_PositionViewWindow(This,hwnd,prc);
}
static inline HRESULT IBrowserService3_IEParseDisplayNameEx(IBrowserService3* This,UINT uiCP,LPCWSTR pwszPath,DWORD dwFlags,PIDLIST_ABSOLUTE *ppidlOut) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBrowserService4_QueryInterface(IBrowserService4* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBrowserService4_AddRef(IBrowserService4* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBrowserService4_Release(IBrowserService4* This) {
    return This->lpVtbl->Release(This);
}
/*** IBrowserService methods ***/
static inline HRESULT IBrowserService4_GetParentSite(IBrowserService4* This,IOleInPlaceSite **ppipsite) {
    return This->lpVtbl->GetParentSite(This,ppipsite);
}
static inline HRESULT IBrowserService4_SetTitle(IBrowserService4* This,IShellView *psv,LPCWSTR pszName) {
    return This->lpVtbl->SetTitle(This,psv,pszName);
}
static inline HRESULT IBrowserService4_GetTitle(IBrowserService4* This,IShellView *psv,LPWSTR pszName,DWORD cchName) {
    return This->lpVtbl->GetTitle(This,psv,pszName,cchName);
}
static inline HRESULT IBrowserService4_GetOleObject(IBrowserService4* This,IOleObject **ppobjv) {
    return This->lpVtbl->GetOleObject(This,ppobjv);
}
static inline HRESULT IBrowserService4_GetTravelLog(IBrowserService4* This,ITravelLog **pptl) {
    return This->lpVtbl->GetTravelLog(This,pptl);
}
static inline HRESULT IBrowserService4_ShowControlWindow(IBrowserService4* This,UINT id,BOOL fShow) {
    return This->lpVtbl->ShowControlWindow(This,id,fShow);
}
static inline HRESULT IBrowserService4_IsControlWindowShown(IBrowserService4* This,UINT id,BOOL *pfShown) {
    return This->lpVtbl->IsControlWindowShown(This,id,pfShown);
}
static inline HRESULT IBrowserService4_IEGetDisplayName(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,LPWSTR pwszName,UINT uFlags) {
    return This->lpVtbl->IEGetDisplayName(This,pidl,pwszName,uFlags);
}
static inline HRESULT IBrowserService4_IEParseDisplayName(IBrowserService4* This,UINT uiCP,LPCWSTR pwszPath,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayName(This,uiCP,pwszPath,ppidlOut);
}
static inline HRESULT IBrowserService4_DisplayParseError(IBrowserService4* This,HRESULT hres,LPCWSTR pwszPath) {
    return This->lpVtbl->DisplayParseError(This,hres,pwszPath);
}
static inline HRESULT IBrowserService4_NavigateToPidl(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF) {
    return This->lpVtbl->NavigateToPidl(This,pidl,grfHLNF);
}
static inline HRESULT IBrowserService4_SetNavigateState(IBrowserService4* This,BNSTATE bnstate) {
    return This->lpVtbl->SetNavigateState(This,bnstate);
}
static inline HRESULT IBrowserService4_GetNavigateState(IBrowserService4* This,BNSTATE *pbnstate) {
    return This->lpVtbl->GetNavigateState(This,pbnstate);
}
static inline HRESULT IBrowserService4_NotifyRedirect(IBrowserService4* This,IShellView *psv,PCIDLIST_ABSOLUTE pidl,BOOL *pfDidBrowse) {
    return This->lpVtbl->NotifyRedirect(This,psv,pidl,pfDidBrowse);
}
static inline HRESULT IBrowserService4_UpdateWindowList(IBrowserService4* This) {
    return This->lpVtbl->UpdateWindowList(This);
}
static inline HRESULT IBrowserService4_UpdateBackForwardState(IBrowserService4* This) {
    return This->lpVtbl->UpdateBackForwardState(This);
}
static inline HRESULT IBrowserService4_SetFlags(IBrowserService4* This,DWORD dwFlags,DWORD dwFlagMask) {
    return This->lpVtbl->SetFlags(This,dwFlags,dwFlagMask);
}
static inline HRESULT IBrowserService4_GetFlags(IBrowserService4* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
static inline HRESULT IBrowserService4_CanNavigateNow(IBrowserService4* This) {
    return This->lpVtbl->CanNavigateNow(This);
}
static inline HRESULT IBrowserService4_GetPidl(IBrowserService4* This,PIDLIST_ABSOLUTE *ppidl) {
    return This->lpVtbl->GetPidl(This,ppidl);
}
static inline HRESULT IBrowserService4_SetReferrer(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->SetReferrer(This,pidl);
}
static inline DWORD IBrowserService4_GetBrowserIndex(IBrowserService4* This) {
    return This->lpVtbl->GetBrowserIndex(This);
}
static inline HRESULT IBrowserService4_GetBrowserByIndex(IBrowserService4* This,DWORD dwID,IUnknown **ppunk) {
    return This->lpVtbl->GetBrowserByIndex(This,dwID,ppunk);
}
static inline HRESULT IBrowserService4_GetHistoryObject(IBrowserService4* This,IOleObject **ppole,IStream **pstm,IBindCtx **ppbc) {
    return This->lpVtbl->GetHistoryObject(This,ppole,pstm,ppbc);
}
static inline HRESULT IBrowserService4_SetHistoryObject(IBrowserService4* This,IOleObject *pole,BOOL fIsLocalAnchor) {
    return This->lpVtbl->SetHistoryObject(This,pole,fIsLocalAnchor);
}
static inline HRESULT IBrowserService4_CacheOLEServer(IBrowserService4* This,IOleObject *pole) {
    return This->lpVtbl->CacheOLEServer(This,pole);
}
static inline HRESULT IBrowserService4_GetSetCodePage(IBrowserService4* This,VARIANT *pvarIn,VARIANT *pvarOut) {
    return This->lpVtbl->GetSetCodePage(This,pvarIn,pvarOut);
}
static inline HRESULT IBrowserService4_OnHttpEquiv(IBrowserService4* This,IShellView *psv,BOOL fDone,VARIANT *pvarargIn,VARIANT *pvarargOut) {
    return This->lpVtbl->OnHttpEquiv(This,psv,fDone,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService4_GetPalette(IBrowserService4* This,HPALETTE *hpal) {
    return This->lpVtbl->GetPalette(This,hpal);
}
static inline HRESULT IBrowserService4_RegisterWindow(IBrowserService4* This,BOOL fForceRegister,int swc) {
    return This->lpVtbl->RegisterWindow(This,fForceRegister,swc);
}
/*** IBrowserService2 methods ***/
static inline LRESULT IBrowserService4_WndProcBS(IBrowserService4* This,HWND hwnd,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->WndProcBS(This,hwnd,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService4_SetAsDefFolderSettings(IBrowserService4* This) {
    return This->lpVtbl->SetAsDefFolderSettings(This);
}
static inline HRESULT IBrowserService4_GetViewRect(IBrowserService4* This,RECT *prc) {
    return This->lpVtbl->GetViewRect(This,prc);
}
static inline HRESULT IBrowserService4_OnSize(IBrowserService4* This,WPARAM wParam) {
    return This->lpVtbl->OnSize(This,wParam);
}
static inline HRESULT IBrowserService4_OnCreate(IBrowserService4* This,struct tagCREATESTRUCTW *pcs) {
    return This->lpVtbl->OnCreate(This,pcs);
}
static inline LRESULT IBrowserService4_OnCommand(IBrowserService4* This,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->OnCommand(This,wParam,lParam);
}
static inline HRESULT IBrowserService4_OnDestroy(IBrowserService4* This) {
    return This->lpVtbl->OnDestroy(This);
}
static inline LRESULT IBrowserService4_OnNotify(IBrowserService4* This,struct tagNMHDR *pnm) {
    return This->lpVtbl->OnNotify(This,pnm);
}
static inline HRESULT IBrowserService4_OnSetFocus(IBrowserService4* This) {
    return This->lpVtbl->OnSetFocus(This);
}
static inline HRESULT IBrowserService4_OnFrameWindowActivateBS(IBrowserService4* This,BOOL fActive) {
    return This->lpVtbl->OnFrameWindowActivateBS(This,fActive);
}
static inline HRESULT IBrowserService4_ReleaseShellView(IBrowserService4* This) {
    return This->lpVtbl->ReleaseShellView(This);
}
static inline HRESULT IBrowserService4_ActivatePendingView(IBrowserService4* This) {
    return This->lpVtbl->ActivatePendingView(This);
}
static inline HRESULT IBrowserService4_CreateViewWindow(IBrowserService4* This,IShellView *psvNew,IShellView *psvOld,LPRECT prcView,HWND *phwnd) {
    return This->lpVtbl->CreateViewWindow(This,psvNew,psvOld,prcView,phwnd);
}
static inline HRESULT IBrowserService4_CreateBrowserPropSheetExt(IBrowserService4* This,REFIID riid,void **ppv) {
    return This->lpVtbl->CreateBrowserPropSheetExt(This,riid,ppv);
}
static inline HRESULT IBrowserService4_GetViewWindow(IBrowserService4* This,HWND *phwndView) {
    return This->lpVtbl->GetViewWindow(This,phwndView);
}
static inline HRESULT IBrowserService4_GetBaseBrowserData(IBrowserService4* This,LPCBASEBROWSERDATA *pbbd) {
    return This->lpVtbl->GetBaseBrowserData(This,pbbd);
}
static inline LPBASEBROWSERDATA IBrowserService4_PutBaseBrowserData(IBrowserService4* This) {
    return This->lpVtbl->PutBaseBrowserData(This);
}
static inline HRESULT IBrowserService4_InitializeTravelLog(IBrowserService4* This,ITravelLog *ptl,DWORD dw) {
    return This->lpVtbl->InitializeTravelLog(This,ptl,dw);
}
static inline HRESULT IBrowserService4_SetTopBrowser(IBrowserService4* This) {
    return This->lpVtbl->SetTopBrowser(This);
}
static inline HRESULT IBrowserService4_Offline(IBrowserService4* This,int iCmd) {
    return This->lpVtbl->Offline(This,iCmd);
}
static inline HRESULT IBrowserService4_AllowViewResize(IBrowserService4* This,BOOL f) {
    return This->lpVtbl->AllowViewResize(This,f);
}
static inline HRESULT IBrowserService4_SetActivateState(IBrowserService4* This,UINT u) {
    return This->lpVtbl->SetActivateState(This,u);
}
static inline HRESULT IBrowserService4_UpdateSecureLockIcon(IBrowserService4* This,int eSecureLock) {
    return This->lpVtbl->UpdateSecureLockIcon(This,eSecureLock);
}
static inline HRESULT IBrowserService4_InitializeDownloadManager(IBrowserService4* This) {
    return This->lpVtbl->InitializeDownloadManager(This);
}
static inline HRESULT IBrowserService4_InitializeTransitionSite(IBrowserService4* This) {
    return This->lpVtbl->InitializeTransitionSite(This);
}
static inline HRESULT IBrowserService4__Initialize(IBrowserService4* This,HWND hwnd,IUnknown *pauto) {
    return This->lpVtbl->_Initialize(This,hwnd,pauto);
}
static inline HRESULT IBrowserService4__CancelPendingNavigationAsync(IBrowserService4* This) {
    return This->lpVtbl->_CancelPendingNavigationAsync(This);
}
static inline HRESULT IBrowserService4__CancelPendingView(IBrowserService4* This) {
    return This->lpVtbl->_CancelPendingView(This);
}
static inline HRESULT IBrowserService4__MaySaveChanges(IBrowserService4* This) {
    return This->lpVtbl->_MaySaveChanges(This);
}
static inline HRESULT IBrowserService4__PauseOrResumeView(IBrowserService4* This,BOOL fPaused) {
    return This->lpVtbl->_PauseOrResumeView(This,fPaused);
}
static inline HRESULT IBrowserService4__DisableModeless(IBrowserService4* This) {
    return This->lpVtbl->_DisableModeless(This);
}
static inline HRESULT IBrowserService4__NavigateToPidl(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
static inline HRESULT IBrowserService4__TryShell2Rename(IBrowserService4* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
    return This->lpVtbl->_TryShell2Rename(This,psv,pidlNew);
}
static inline HRESULT IBrowserService4__SwitchActivationNow(IBrowserService4* This) {
    return This->lpVtbl->_SwitchActivationNow(This);
}
static inline HRESULT IBrowserService4__ExecChildren(IBrowserService4* This,IUnknown *punkBar,BOOL fBroadcast,const GUID *pguidCmdGroup,DWORD nCmdID,DWORD nCmdexecopt,VARIANTARG *pvarargIn,VARIANTARG *pvarargOut) {
    return This->lpVtbl->_ExecChildren(This,punkBar,fBroadcast,pguidCmdGroup,nCmdID,nCmdexecopt,pvarargIn,pvarargOut);
}
static inline HRESULT IBrowserService4__SendChildren(IBrowserService4* This,HWND hwndBar,BOOL fBroadcast,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->_SendChildren(This,hwndBar,fBroadcast,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService4_GetFolderSetData(IBrowserService4* This,struct tagFolderSetData *pfsd) {
    return This->lpVtbl->GetFolderSetData(This,pfsd);
}
static inline HRESULT IBrowserService4__OnFocusChange(IBrowserService4* This,UINT itb) {
    return This->lpVtbl->_OnFocusChange(This,itb);
}
static inline HRESULT IBrowserService4_v_ShowHideChildWindows(IBrowserService4* This,BOOL fChildOnly) {
    return This->lpVtbl->v_ShowHideChildWindows(This,fChildOnly);
}
static inline UINT IBrowserService4__get_itbLastFocus(IBrowserService4* This) {
    return This->lpVtbl->_get_itbLastFocus(This);
}
static inline HRESULT IBrowserService4__put_itbLastFocus(IBrowserService4* This,UINT itbLastFocus) {
    return This->lpVtbl->_put_itbLastFocus(This,itbLastFocus);
}
static inline HRESULT IBrowserService4__UIActivateView(IBrowserService4* This,UINT uState) {
    return This->lpVtbl->_UIActivateView(This,uState);
}
static inline HRESULT IBrowserService4__GetViewBorderRect(IBrowserService4* This,RECT *prc) {
    return This->lpVtbl->_GetViewBorderRect(This,prc);
}
static inline HRESULT IBrowserService4__UpdateViewRectSize(IBrowserService4* This) {
    return This->lpVtbl->_UpdateViewRectSize(This);
}
static inline HRESULT IBrowserService4__ResizeNextBorder(IBrowserService4* This,UINT itb) {
    return This->lpVtbl->_ResizeNextBorder(This,itb);
}
static inline HRESULT IBrowserService4__ResizeView(IBrowserService4* This) {
    return This->lpVtbl->_ResizeView(This);
}
static inline HRESULT IBrowserService4__GetEffectiveClientArea(IBrowserService4* This,LPRECT lprectBorder,HMONITOR hmon) {
    return This->lpVtbl->_GetEffectiveClientArea(This,lprectBorder,hmon);
}
static inline IStream * IBrowserService4_v_GetViewStream(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
    return This->lpVtbl->v_GetViewStream(This,pidl,grfMode,pwszName);
}
static inline LRESULT IBrowserService4_ForwardViewMsg(IBrowserService4* This,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->ForwardViewMsg(This,uMsg,wParam,lParam);
}
static inline HRESULT IBrowserService4_SetAcceleratorMenu(IBrowserService4* This,HACCEL hacc) {
    return This->lpVtbl->SetAcceleratorMenu(This,hacc);
}
static inline int IBrowserService4__GetToolbarCount(IBrowserService4* This) {
    return This->lpVtbl->_GetToolbarCount(This);
}
static inline LPTOOLBARITEM IBrowserService4__GetToolbarItem(IBrowserService4* This,int itb) {
    return This->lpVtbl->_GetToolbarItem(This,itb);
}
static inline HRESULT IBrowserService4__SaveToolbars(IBrowserService4* This,IStream *pstm) {
    return This->lpVtbl->_SaveToolbars(This,pstm);
}
static inline HRESULT IBrowserService4__LoadToolbars(IBrowserService4* This,IStream *pstm) {
    return This->lpVtbl->_LoadToolbars(This,pstm);
}
static inline HRESULT IBrowserService4__CloseAndReleaseToolbars(IBrowserService4* This,BOOL fClose) {
    return This->lpVtbl->_CloseAndReleaseToolbars(This,fClose);
}
static inline HRESULT IBrowserService4_v_MayGetNextToolbarFocus(IBrowserService4* This,LPMSG lpMsg,UINT itbNext,int citb,LPTOOLBARITEM *pptbi,HWND *phwnd) {
    return This->lpVtbl->v_MayGetNextToolbarFocus(This,lpMsg,itbNext,citb,pptbi,phwnd);
}
static inline HRESULT IBrowserService4__ResizeNextBorderHelper(IBrowserService4* This,UINT itb,BOOL bUseHmonitor) {
    return This->lpVtbl->_ResizeNextBorderHelper(This,itb,bUseHmonitor);
}
static inline UINT IBrowserService4__FindTBar(IBrowserService4* This,IUnknown *punkSrc) {
    return This->lpVtbl->_FindTBar(This,punkSrc);
}
static inline HRESULT IBrowserService4__SetFocus(IBrowserService4* This,LPTOOLBARITEM ptbi,HWND hwnd,LPMSG lpMsg) {
    return This->lpVtbl->_SetFocus(This,ptbi,hwnd,lpMsg);
}
static inline HRESULT IBrowserService4_v_MayTranslateAccelerator(IBrowserService4* This,MSG *pmsg) {
    return This->lpVtbl->v_MayTranslateAccelerator(This,pmsg);
}
static inline HRESULT IBrowserService4__GetBorderDWHelper(IBrowserService4* This,IUnknown *punkSrc,LPRECT lprectBorder,BOOL bUseHmonitor) {
    return This->lpVtbl->_GetBorderDWHelper(This,punkSrc,lprectBorder,bUseHmonitor);
}
static inline HRESULT IBrowserService4_v_CheckZoneCrossing(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->v_CheckZoneCrossing(This,pidl);
}
/*** IBrowserService3 methods ***/
static inline HRESULT IBrowserService4__PositionViewWindow(IBrowserService4* This,HWND hwnd,LPRECT prc) {
    return This->lpVtbl->_PositionViewWindow(This,hwnd,prc);
}
static inline HRESULT IBrowserService4_IEParseDisplayNameEx(IBrowserService4* This,UINT uiCP,LPCWSTR pwszPath,DWORD dwFlags,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayNameEx(This,uiCP,pwszPath,dwFlags,ppidlOut);
}
/*** IBrowserService4 methods ***/
static inline HRESULT IBrowserService4_ActivateView(IBrowserService4* This,BOOL fPendingView) {
    return This->lpVtbl->ActivateView(This,fPendingView);
}
static inline HRESULT IBrowserService4_SaveViewState(IBrowserService4* This) {
    return This->lpVtbl->SaveViewState(This);
}
static inline HRESULT IBrowserService4__ResizeAllBorders(IBrowserService4* This) {
