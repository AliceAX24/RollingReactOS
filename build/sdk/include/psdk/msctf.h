...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfContextOwner_QueryInterface(ITfContextOwner* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfContextOwner_AddRef(ITfContextOwner* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfContextOwner_Release(ITfContextOwner* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfContextOwner methods ***/
static inline HRESULT ITfContextOwner_GetACPFromPoint(ITfContextOwner* This,const POINT *ptScreen,DWORD dwFlags,LONG *pacp) {
    return This->lpVtbl->GetACPFromPoint(This,ptScreen,dwFlags,pacp);
}
static inline HRESULT ITfContextOwner_GetTextExt(ITfContextOwner* This,LONG acpStart,LONG acpEnd,RECT *prc,BOOL *pfClipped) {
    return This->lpVtbl->GetTextExt(This,acpStart,acpEnd,prc,pfClipped);
}
static inline HRESULT ITfContextOwner_GetScreenExt(ITfContextOwner* This,RECT *prc) {
    return This->lpVtbl->GetScreenExt(This,prc);
}
static inline HRESULT ITfContextOwner_GetStatus(ITfContextOwner* This,TF_STATUS *pdcs) {
    return This->lpVtbl->GetStatus(This,pdcs);
}
static inline HRESULT ITfContextOwner_GetWnd(ITfContextOwner* This,HWND *phwnd) {
    return This->lpVtbl->GetWnd(This,phwnd);
}
static inline HRESULT ITfContextOwner_GetAttribute(ITfContextOwner* This,REFGUID rguidAttribute,VARIANT *pvarValue) {
...
typedef enum __WIDL_msctf_generated_name_00000019 {
    TF_GRAVITY_BACKWARD = 0,
    TF_GRAVITY_FORWARD = 1
} TfGravity;
typedef enum __WIDL_msctf_generated_name_0000001A {
    TF_SD_BACKWARD = 0,
    TF_SD_FORWARD = 1
} TfShiftDir;
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfCleanupContextSink_QueryInterface(ITfCleanupContextSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfCleanupContextSink_AddRef(ITfCleanupContextSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfCleanupContextSink_Release(ITfCleanupContextSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfCleanupContextSink methods ***/
static inline HRESULT ITfCleanupContextSink_OnCleanupContext(ITfCleanupContextSink* This,TfEditCookie ecWrite,ITfContext *pic) {
...
typedef enum __WIDL_msctf_generated_name_0000001B {
    TF_LC_CREATE = 0,
    TF_LC_CHANGE = 1,
    TF_LC_DESTROY = 2
} TfLayoutCode;
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfTextLayoutSink_QueryInterface(ITfTextLayoutSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfTextLayoutSink_AddRef(ITfTextLayoutSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfTextLayoutSink_Release(ITfTextLayoutSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfTextLayoutSink methods ***/
static inline HRESULT ITfTextLayoutSink_OnLayoutChange(ITfTextLayoutSink* This,ITfContext *pic,TfLayoutCode lcode,ITfContextView *pView) {
