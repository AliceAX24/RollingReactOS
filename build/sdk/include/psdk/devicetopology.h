...
#include <ksmedia.h>
#ifndef _KS_
typedef struct __WIDL_devicetopology_generated_name_0000001C {
    ULONG FormatSize;
    ULONG Flags;
    ULONG SampleSize;
    ULONG Reserved;
...
typedef enum __WIDL_devicetopology_generated_name_0000001E {
    eConnTypeUnknown = 0,
...
typedef struct __WIDL_devicetopology_generated_name_00000022 {
