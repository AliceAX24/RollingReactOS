...
typedef enum __WIDL_textstor_generated_name_0000000D {
    TS_AE_NONE = 0,
    TS_AE_START = 1,
    TS_AE_END = 2
} TsActiveSelEnd;
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAnchor_QueryInterface(IAnchor* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAnchor_AddRef(IAnchor* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAnchor_Release(IAnchor* This) {
    return This->lpVtbl->Release(This);
}
/*** IAnchor methods ***/
static inline HRESULT IAnchor_SetGravity(IAnchor* This,TsGravity gravity) {
    return This->lpVtbl->SetGravity(This,gravity);
}
static inline HRESULT IAnchor_GetGravity(IAnchor* This,TsGravity *pgravity) {
    return This->lpVtbl->GetGravity(This,pgravity);
}
static inline HRESULT IAnchor_IsEqual(IAnchor* This,IAnchor *paWith,BOOL *pfEqual) {
    return This->lpVtbl->IsEqual(This,paWith,pfEqual);
}
static inline HRESULT IAnchor_Compare(IAnchor* This,IAnchor *paWith,LONG *plResult) {
    return This->lpVtbl->Compare(This,paWith,plResult);
}
static inline HRESULT IAnchor_Shift(IAnchor* This,DWORD dwFlags,LONG cchReq,LONG *pcch,IAnchor *paHaltAnchor) {
    return This->lpVtbl->Shift(This,dwFlags,cchReq,pcch,paHaltAnchor);
}
static inline HRESULT IAnchor_ShiftTo(IAnchor* This,IAnchor *paSite) {
    return This->lpVtbl->ShiftTo(This,paSite);
}
static inline HRESULT IAnchor_ShiftRegion(IAnchor* This,DWORD dwFlags,TsShiftDir dir,BOOL *pfNoRegion) {
    return This->lpVtbl->ShiftRegion(This,dwFlags,dir,pfNoRegion);
}
static inline HRESULT IAnchor_SetChangeHistoryMask(IAnchor* This,DWORD dwMask) {
    return This->lpVtbl->SetChangeHistoryMask(This,dwMask);
}
static inline HRESULT IAnchor_GetChangeHistory(IAnchor* This,DWORD *pdwHistory) {
    return This->lpVtbl->GetChangeHistory(This,pdwHistory);
}
static inline HRESULT IAnchor_ClearChangeHistory(IAnchor* This) {
    return This->lpVtbl->ClearChangeHistory(This);
}
static inline HRESULT IAnchor_Clone(IAnchor* This,IAnchor **ppaClone) {
