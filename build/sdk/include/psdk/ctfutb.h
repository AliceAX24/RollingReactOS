...
typedef enum __WIDL_ctfutb_generated_name_0000000D {
    TF_LBI_CLK_RIGHT = 1,
    TF_LBI_CLK_LEFT = 2
} TfLBIClick;
#ifndef __ITfLangBarEventSink_FWD_DEFINED__
...
typedef enum __WIDL_ctfutb_generated_name_0000000E {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfLangBarItemBalloon_QueryInterface(ITfLangBarItemBalloon* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfLangBarItemBalloon_AddRef(ITfLangBarItemBalloon* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfLangBarItemBalloon_Release(ITfLangBarItemBalloon* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfLangBarItemBalloon methods ***/
static inline HRESULT ITfLangBarItemBalloon_OnClick(ITfLangBarItemBalloon* This,TfLBIClick click,POINT pt,const RECT *prcArea) {
    return This->lpVtbl->OnClick(This,click,pt,prcArea);
}
static inline HRESULT ITfLangBarItemBalloon_GetPreferredSize(ITfLangBarItemBalloon* This,const SIZE *pszDefault,SIZE *psz) {
    return This->lpVtbl->GetPreferredSize(This,pszDefault,psz);
}
static inline HRESULT ITfLangBarItemBalloon_GetBalloonInfo(ITfLangBarItemBalloon* This,TF_LBBALLOONINFO *pInfo) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfLangBarItemBitmap_QueryInterface(ITfLangBarItemBitmap* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfLangBarItemBitmap_AddRef(ITfLangBarItemBitmap* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfLangBarItemBitmap_Release(ITfLangBarItemBitmap* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfLangBarItemBitmap methods ***/
static inline HRESULT ITfLangBarItemBitmap_OnClick(ITfLangBarItemBitmap* This,TfLBIClick click,POINT pt,const RECT *prcArea) {
    return This->lpVtbl->OnClick(This,click,pt,prcArea);
}
static inline HRESULT ITfLangBarItemBitmap_GetPreferredSize(ITfLangBarItemBitmap* This,const SIZE *pszDefault,SIZE *psz) {
    return This->lpVtbl->GetPreferredSize(This,pszDefault,psz);
}
static inline HRESULT ITfLangBarItemBitmap_DrawBitmap(ITfLangBarItemBitmap* This,LONG bmWidth,LONG bmHeight,DWORD dwFlags,HBITMAP *phbmp,HBITMAP *phbmpMask) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfLangBarItemBitmapButton_QueryInterface(ITfLangBarItemBitmapButton* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfLangBarItemBitmapButton_AddRef(ITfLangBarItemBitmapButton* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfLangBarItemBitmapButton_Release(ITfLangBarItemBitmapButton* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfLangBarItemBitmapButton methods ***/
static inline HRESULT ITfLangBarItemBitmapButton_OnClick(ITfLangBarItemBitmapButton* This,TfLBIClick click,POINT pt,const RECT *prcArea) {
    return This->lpVtbl->OnClick(This,click,pt,prcArea);
}
static inline HRESULT ITfLangBarItemBitmapButton_InitMenu(ITfLangBarItemBitmapButton* This,ITfMenu *pMenu) {
    return This->lpVtbl->InitMenu(This,pMenu);
}
static inline HRESULT ITfLangBarItemBitmapButton_OnMenuSelect(ITfLangBarItemBitmapButton* This,UINT wID) {
    return This->lpVtbl->OnMenuSelect(This,wID);
}
static inline HRESULT ITfLangBarItemBitmapButton_GetPreferredSize(ITfLangBarItemBitmapButton* This,const SIZE *pszDefault,SIZE *psz) {
    return This->lpVtbl->GetPreferredSize(This,pszDefault,psz);
}
static inline HRESULT ITfLangBarItemBitmapButton_DrawBitmap(ITfLangBarItemBitmapButton* This,LONG bmWidth,LONG bmHeight,DWORD dwFlags,HBITMAP *phbmp,HBITMAP *phbmpMask) {
    return This->lpVtbl->DrawBitmap(This,bmWidth,bmHeight,dwFlags,phbmp,phbmpMask);
}
static inline HRESULT ITfLangBarItemBitmapButton_GetText(ITfLangBarItemBitmapButton* This,BSTR *pbstrText) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfLangBarItemButton_QueryInterface(ITfLangBarItemButton* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfLangBarItemButton_AddRef(ITfLangBarItemButton* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfLangBarItemButton_Release(ITfLangBarItemButton* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfLangBarItemButton methods ***/
static inline HRESULT ITfLangBarItemButton_OnClick(ITfLangBarItemButton* This,TfLBIClick click,POINT pt,const RECT *prcArea) {
    return This->lpVtbl->OnClick(This,click,pt,prcArea);
}
static inline HRESULT ITfLangBarItemButton_InitMenu(ITfLangBarItemButton* This,ITfMenu *pMenu) {
    return This->lpVtbl->InitMenu(This,pMenu);
}
static inline HRESULT ITfLangBarItemButton_OnMenuSelect(ITfLangBarItemButton* This,UINT wID) {
    return This->lpVtbl->OnMenuSelect(This,wID);
}
static inline HRESULT ITfLangBarItemButton_GetIcon(ITfLangBarItemButton* This,HICON *phIcon) {
    return This->lpVtbl->GetIcon(This,phIcon);
}
static inline HRESULT ITfLangBarItemButton_GetText(ITfLangBarItemButton* This,BSTR *pbstrText) {
    return This->lpVtbl->GetText(This,pbstrText);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfMenu_QueryInterface(ITfMenu* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfMenu_AddRef(ITfMenu* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfMenu_Release(ITfMenu* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfMenu methods ***/
static inline HRESULT ITfMenu_AddMenuItem(ITfMenu* This,UINT uId,DWORD dwFlags,HBITMAP hbmp,HBITMAP hbmpMask,const WCHAR *pch,ULONG cch,ITfMenu **ppMenu) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfSystemDeviceTypeLangBarItem_QueryInterface(ITfSystemDeviceTypeLangBarItem* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfSystemDeviceTypeLangBarItem_AddRef(ITfSystemDeviceTypeLangBarItem* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfSystemDeviceTypeLangBarItem_Release(ITfSystemDeviceTypeLangBarItem* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfSystemDeviceTypeLangBarItem methods ***/
static inline HRESULT ITfSystemDeviceTypeLangBarItem_SetIconMode(ITfSystemDeviceTypeLangBarItem* This,DWORD dwFlags) {
    return This->lpVtbl->SetIconMode(This,dwFlags);
}
static inline HRESULT ITfSystemDeviceTypeLangBarItem_GetIconMode(ITfSystemDeviceTypeLangBarItem* This,DWORD *pdwFlags) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfSystemLangBarItem_QueryInterface(ITfSystemLangBarItem* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfSystemLangBarItem_AddRef(ITfSystemLangBarItem* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfSystemLangBarItem_Release(ITfSystemLangBarItem* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfSystemLangBarItem methods ***/
static inline HRESULT ITfSystemLangBarItem_SetIcon(ITfSystemLangBarItem* This,HICON hIcon) {
    return This->lpVtbl->SetIcon(This,hIcon);
}
static inline HRESULT ITfSystemLangBarItem_SetTooltipString(ITfSystemLangBarItem* This,WCHAR *pchToolTip,ULONG cch) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfSystemLangBarItemSink_QueryInterface(ITfSystemLangBarItemSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfSystemLangBarItemSink_AddRef(ITfSystemLangBarItemSink* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfSystemLangBarItemSink_Release(ITfSystemLangBarItemSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfSystemLangBarItemSink methods ***/
static inline HRESULT ITfSystemLangBarItemSink_InitMenu(ITfSystemLangBarItemSink* This,ITfMenu *pMenu) {
    return This->lpVtbl->InitMenu(This,pMenu);
}
static inline HRESULT ITfSystemLangBarItemSink_OnMenuSelect(ITfSystemLangBarItemSink* This,UINT wID) {
    return This->lpVtbl->OnMenuSelect(This,wID);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITfSystemLangBarItemText_QueryInterface(ITfSystemLangBarItemText* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITfSystemLangBarItemText_AddRef(ITfSystemLangBarItemText* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITfSystemLangBarItemText_Release(ITfSystemLangBarItemText* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfSystemLangBarItemText methods ***/
static inline HRESULT ITfSystemLangBarItemText_SetItemText(ITfSystemLangBarItemText* This,const WCHAR *pch,ULONG cch) {
    return This->lpVtbl->SetItemText(This,pch,cch);
}
static inline HRESULT ITfSystemLangBarItemText_GetItemText(ITfSystemLangBarItemText* This,BSTR *pbstrText) {
