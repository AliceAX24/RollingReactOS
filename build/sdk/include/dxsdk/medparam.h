/*** Autogenerated by WIDL <undefined version> from medparam.idl - Do not edit ***/
...
IMediaParams : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE AddEnvelope(
        DWORD dwParamIndex,
        DWORD cSegments,
        MP_ENVELOPE_SEGMENT *pEnvelopeSegments) = 0;
...
static inline HRESULT IMediaParams_AddEnvelope(IMediaParams* This,DWORD dwParamIndex,DWORD cSegments,MP_ENVELOPE_SEGMENT *pEnvelopeSegments) {
    return This->lpVtbl->AddEnvelope(This,dwParamIndex,cSegments,pEnvelopeSegments);
}
