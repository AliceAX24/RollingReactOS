/*** Autogenerated by WIDL <undefined version> from tvratings.idl - Do not edit ***/
...
typedef enum __WIDL_tvratings_generated_name_0000001C {
    MPAA = 0,
    US_TV = 1,
    Canadian_English = 2,
    Canadian_French = 3,
...
typedef enum __WIDL_tvratings_generated_name_0000001D {
    TvRat_0 = 0,
    TvRat_1 = 1,
    TvRat_2 = 2,
    TvRat_3 = 3,
...
typedef enum __WIDL_tvratings_generated_name_0000001E {
...
typedef enum __WIDL_tvratings_generated_name_0000001F {
    US_TV_None = TvRat_0,
    US_TV_Y = TvRat_1,
    US_TV_Y7 = TvRat_2,
    US_TV_G = TvRat_3,
...
typedef enum __WIDL_tvratings_generated_name_00000020 {
...
typedef enum __WIDL_tvratings_generated_name_00000021 {
...
typedef enum __WIDL_tvratings_generated_name_00000022 {
    BfAttrNone = 0,
    BfIsBlocked = 1,
    BfIsAttr_1 = 2,
    BfIsAttr_2 = 4,
...
typedef enum __WIDL_tvratings_generated_name_00000023 {
...
typedef enum __WIDL_tvratings_generated_name_00000024 {
    MPAA_IsBlocked = BfIsBlocked,
    MPAA_ValidAttrSubmask = 1
} BfEnTvRat_Attributes_MPAA;
typedef enum __WIDL_tvratings_generated_name_00000025 {
    CAE_IsBlocked = BfIsBlocked,
    CAE_ValidAttrSubmask = 1
} BfEnTvRat_Attributes_CAE_TV;
typedef enum __WIDL_tvratings_generated_name_00000026 {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXDSToRat_QueryInterface(IXDSToRat* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IXDSToRat_AddRef(IXDSToRat* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IXDSToRat_Release(IXDSToRat* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IXDSToRat_GetTypeInfoCount(IXDSToRat* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IXDSToRat_GetTypeInfo(IXDSToRat* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IXDSToRat_GetIDsOfNames(IXDSToRat* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IXDSToRat_Invoke(IXDSToRat* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IXDSToRat methods ***/
static inline HRESULT IXDSToRat_Init(IXDSToRat* This) {
    return This->lpVtbl->Init(This);
}
static inline HRESULT IXDSToRat_ParseXDSBytePair(IXDSToRat* This,BYTE byte1,BYTE byte2,EnTvRat_System *pEnSystem,EnTvRat_GenericLevel *pEnLevel,LONG *plBfEnAttributes) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEvalRat_QueryInterface(IEvalRat* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEvalRat_AddRef(IEvalRat* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEvalRat_Release(IEvalRat* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IEvalRat_GetTypeInfoCount(IEvalRat* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IEvalRat_GetTypeInfo(IEvalRat* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IEvalRat_GetIDsOfNames(IEvalRat* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IEvalRat_Invoke(IEvalRat* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IEvalRat methods ***/
static inline HRESULT IEvalRat_get_BlockedRatingAttributes(IEvalRat* This,EnTvRat_System enSystem,EnTvRat_GenericLevel enLevel,LONG *plbfAttrs) {
    return This->lpVtbl->get_BlockedRatingAttributes(This,enSystem,enLevel,plbfAttrs);
}
static inline HRESULT IEvalRat_put_BlockedRatingAttributes(IEvalRat* This,EnTvRat_System enSystem,EnTvRat_GenericLevel enLevel,LONG lbfAttrs) {
    return This->lpVtbl->put_BlockedRatingAttributes(This,enSystem,enLevel,lbfAttrs);
}
static inline HRESULT IEvalRat_get_BlockUnRated(IEvalRat* This,BOOL *pfBlockUnRatedShows) {
    return This->lpVtbl->get_BlockUnRated(This,pfBlockUnRatedShows);
}
static inline HRESULT IEvalRat_put_BlockUnRated(IEvalRat* This,BOOL fBlockUnRatedShows) {
    return This->lpVtbl->put_BlockUnRated(This,fBlockUnRatedShows);
}
static inline HRESULT IEvalRat_MostRestrictiveRating(IEvalRat* This,EnTvRat_System enSystem1,EnTvRat_GenericLevel enEnLevel1,LONG lbfEnAttr1,EnTvRat_System enSystem2,EnTvRat_GenericLevel enEnLevel2,LONG lbfEnAttr2,EnTvRat_System *penSystem,EnTvRat_GenericLevel *penEnLevel,LONG *plbfEnAttr) {
...
static inline HRESULT IEvalRat_TestRating(IEvalRat* This,EnTvRat_System enShowSystem,EnTvRat_GenericLevel enShowLevel,LONG lbfEnShowAttributes) {
