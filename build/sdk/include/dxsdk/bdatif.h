/*** Autogenerated by WIDL <undefined version> from bdatif.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBDA_TIF_REGISTRATION_QueryInterface(IBDA_TIF_REGISTRATION* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBDA_TIF_REGISTRATION_AddRef(IBDA_TIF_REGISTRATION* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBDA_TIF_REGISTRATION_Release(IBDA_TIF_REGISTRATION* This) {
    return This->lpVtbl->Release(This);
}
/*** IBDA_TIF_REGISTRATION methods ***/
static inline HRESULT IBDA_TIF_REGISTRATION_RegisterTIFEx(IBDA_TIF_REGISTRATION* This,IPin *pTIFInputPin,ULONG *ppvRegistrationContext,IUnknown **ppMpeg2DataControl) {
    return This->lpVtbl->RegisterTIFEx(This,pTIFInputPin,ppvRegistrationContext,ppMpeg2DataControl);
}
static inline HRESULT IBDA_TIF_REGISTRATION_UnregisterTIF(IBDA_TIF_REGISTRATION* This,ULONG pvRegistrationContext) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMPEG2_TIF_CONTROL_QueryInterface(IMPEG2_TIF_CONTROL* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMPEG2_TIF_CONTROL_AddRef(IMPEG2_TIF_CONTROL* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMPEG2_TIF_CONTROL_Release(IMPEG2_TIF_CONTROL* This) {
    return This->lpVtbl->Release(This);
}
/*** IMPEG2_TIF_CONTROL methods ***/
static inline HRESULT IMPEG2_TIF_CONTROL_RegisterTIF(IMPEG2_TIF_CONTROL* This,IUnknown *pUnkTIF,ULONG *ppvRegistrationContext) {
    return This->lpVtbl->RegisterTIF(This,pUnkTIF,ppvRegistrationContext);
}
static inline HRESULT IMPEG2_TIF_CONTROL_UnregisterTIF(IMPEG2_TIF_CONTROL* This,ULONG pvRegistrationContext) {
    return This->lpVtbl->UnregisterTIF(This,pvRegistrationContext);
}
static inline HRESULT IMPEG2_TIF_CONTROL_AddPIDs(IMPEG2_TIF_CONTROL* This,ULONG ulcPIDs,ULONG *pulPIDs) {
    return This->lpVtbl->AddPIDs(This,ulcPIDs,pulPIDs);
}
static inline HRESULT IMPEG2_TIF_CONTROL_DeletePIDs(IMPEG2_TIF_CONTROL* This,ULONG ulcPIDs,ULONG *pulPIDs) {
    return This->lpVtbl->DeletePIDs(This,ulcPIDs,pulPIDs);
}
static inline HRESULT IMPEG2_TIF_CONTROL_GetPIDCount(IMPEG2_TIF_CONTROL* This,ULONG *pulcPIDs) {
    return This->lpVtbl->GetPIDCount(This,pulcPIDs);
}
static inline HRESULT IMPEG2_TIF_CONTROL_GetPIDs(IMPEG2_TIF_CONTROL* This,ULONG *pulcPIDs,ULONG *pulPIDs) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITuneRequestInfo_QueryInterface(ITuneRequestInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITuneRequestInfo_AddRef(ITuneRequestInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITuneRequestInfo_Release(ITuneRequestInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** ITuneRequestInfo methods ***/
static inline HRESULT ITuneRequestInfo_GetLocatorData(ITuneRequestInfo* This,ITuneRequest *Request) {
    return This->lpVtbl->GetLocatorData(This,Request);
}
static inline HRESULT ITuneRequestInfo_GetComponentData(ITuneRequestInfo* This,ITuneRequest *CurrentRequest) {
    return This->lpVtbl->GetComponentData(This,CurrentRequest);
}
static inline HRESULT ITuneRequestInfo_CreateComponentList(ITuneRequestInfo* This,ITuneRequest *CurrentRequest) {
    return This->lpVtbl->CreateComponentList(This,CurrentRequest);
}
static inline HRESULT ITuneRequestInfo_GetNextProgram(ITuneRequestInfo* This,ITuneRequest *CurrentRequest,ITuneRequest **TuneRequest) {
    return This->lpVtbl->GetNextProgram(This,CurrentRequest,TuneRequest);
}
static inline HRESULT ITuneRequestInfo_GetPreviousProgram(ITuneRequestInfo* This,ITuneRequest *CurrentRequest,ITuneRequest **TuneRequest) {
    return This->lpVtbl->GetPreviousProgram(This,CurrentRequest,TuneRequest);
}
static inline HRESULT ITuneRequestInfo_GetNextLocator(ITuneRequestInfo* This,ITuneRequest *CurrentRequest,ITuneRequest **TuneRequest) {
    return This->lpVtbl->GetNextLocator(This,CurrentRequest,TuneRequest);
}
static inline HRESULT ITuneRequestInfo_GetPreviousLocator(ITuneRequestInfo* This,ITuneRequest *CurrentRequest,ITuneRequest **TuneRequest) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IGuideDataEvent_QueryInterface(IGuideDataEvent* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IGuideDataEvent_AddRef(IGuideDataEvent* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IGuideDataEvent_Release(IGuideDataEvent* This) {
    return This->lpVtbl->Release(This);
}
/*** IGuideDataEvent methods ***/
static inline HRESULT IGuideDataEvent_GuideDataAcquired(IGuideDataEvent* This) {
    return This->lpVtbl->GuideDataAcquired(This);
}
static inline HRESULT IGuideDataEvent_ProgramChanged(IGuideDataEvent* This,VARIANT varProgramDescriptionID) {
    return This->lpVtbl->ProgramChanged(This,varProgramDescriptionID);
}
static inline HRESULT IGuideDataEvent_ServiceChanged(IGuideDataEvent* This,VARIANT varServiceDescriptionID) {
    return This->lpVtbl->ServiceChanged(This,varServiceDescriptionID);
}
static inline HRESULT IGuideDataEvent_ScheduleEntryChanged(IGuideDataEvent* This,VARIANT varScheduleEntryDescriptionID) {
    return This->lpVtbl->ScheduleEntryChanged(This,varScheduleEntryDescriptionID);
}
static inline HRESULT IGuideDataEvent_ProgramDeleted(IGuideDataEvent* This,VARIANT varProgramDescriptionID) {
    return This->lpVtbl->ProgramDeleted(This,varProgramDescriptionID);
}
static inline HRESULT IGuideDataEvent_ServiceDeleted(IGuideDataEvent* This,VARIANT varServiceDescriptionID) {
    return This->lpVtbl->ServiceDeleted(This,varServiceDescriptionID);
}
static inline HRESULT IGuideDataEvent_ScheduleDeleted(IGuideDataEvent* This,VARIANT varScheduleEntryDescriptionID) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IGuideDataProperty_QueryInterface(IGuideDataProperty* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IGuideDataProperty_AddRef(IGuideDataProperty* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IGuideDataProperty_Release(IGuideDataProperty* This) {
    return This->lpVtbl->Release(This);
}
/*** IGuideDataProperty methods ***/
static inline HRESULT IGuideDataProperty_get_Name(IGuideDataProperty* This,BSTR *pbstrName) {
    return This->lpVtbl->get_Name(This,pbstrName);
}
static inline HRESULT IGuideDataProperty_get_Language(IGuideDataProperty* This,LONG *idLang) {
    return This->lpVtbl->get_Language(This,idLang);
}
static inline HRESULT IGuideDataProperty_get_Value(IGuideDataProperty* This,VARIANT *pvar) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumGuideDataProperties_QueryInterface(IEnumGuideDataProperties* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEnumGuideDataProperties_AddRef(IEnumGuideDataProperties* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEnumGuideDataProperties_Release(IEnumGuideDataProperties* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumGuideDataProperties methods ***/
static inline HRESULT IEnumGuideDataProperties_Next(IEnumGuideDataProperties* This,ULONG celt,IGuideDataProperty **ppprop,ULONG *pcelt) {
    return This->lpVtbl->Next(This,celt,ppprop,pcelt);
}
static inline HRESULT IEnumGuideDataProperties_Skip(IEnumGuideDataProperties* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static inline HRESULT IEnumGuideDataProperties_Reset(IEnumGuideDataProperties* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IEnumGuideDataProperties_Clone(IEnumGuideDataProperties* This,IEnumGuideDataProperties **ppenum) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumTuneRequests_QueryInterface(IEnumTuneRequests* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEnumTuneRequests_AddRef(IEnumTuneRequests* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEnumTuneRequests_Release(IEnumTuneRequests* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumTuneRequests methods ***/
static inline HRESULT IEnumTuneRequests_Next(IEnumTuneRequests* This,ULONG celt,ITuneRequest **ppprop,ULONG *pcelt) {
    return This->lpVtbl->Next(This,celt,ppprop,pcelt);
}
static inline HRESULT IEnumTuneRequests_Skip(IEnumTuneRequests* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static inline HRESULT IEnumTuneRequests_Reset(IEnumTuneRequests* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IEnumTuneRequests_Clone(IEnumTuneRequests* This,IEnumTuneRequests **ppenum) {
    return This->lpVtbl->Clone(This,ppenum);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IGuideData_QueryInterface(IGuideData* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IGuideData_AddRef(IGuideData* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IGuideData_Release(IGuideData* This) {
    return This->lpVtbl->Release(This);
}
/*** IGuideData methods ***/
static inline HRESULT IGuideData_GetServices(IGuideData* This,IEnumTuneRequests **ppEnumTuneRequests) {
    return This->lpVtbl->GetServices(This,ppEnumTuneRequests);
}
static inline HRESULT IGuideData_GetServiceProperties(IGuideData* This,ITuneRequest *pTuneRequest,IEnumGuideDataProperties **ppEnumProperties) {
    return This->lpVtbl->GetServiceProperties(This,pTuneRequest,ppEnumProperties);
}
static inline HRESULT IGuideData_GetGuideProgramIDs(IGuideData* This,IEnumVARIANT **pEnumPrograms) {
    return This->lpVtbl->GetGuideProgramIDs(This,pEnumPrograms);
}
static inline HRESULT IGuideData_GetProgramProperties(IGuideData* This,VARIANT varProgramDescriptionID,IEnumGuideDataProperties **ppEnumProperties) {
    return This->lpVtbl->GetProgramProperties(This,varProgramDescriptionID,ppEnumProperties);
}
static inline HRESULT IGuideData_GetScheduleEntryIDs(IGuideData* This,IEnumVARIANT **pEnumScheduleEntries) {
    return This->lpVtbl->GetScheduleEntryIDs(This,pEnumScheduleEntries);
}
static inline HRESULT IGuideData_GetScheduleEntryProperties(IGuideData* This,VARIANT varScheduleEntryDescriptionID,IEnumGuideDataProperties **ppEnumProperties) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IGuideDataLoader_QueryInterface(IGuideDataLoader* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IGuideDataLoader_AddRef(IGuideDataLoader* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IGuideDataLoader_Release(IGuideDataLoader* This) {
    return This->lpVtbl->Release(This);
}
/*** IGuideDataLoader methods ***/
static inline HRESULT IGuideDataLoader_Init(IGuideDataLoader* This,IGuideData *pGuideStore) {
    return This->lpVtbl->Init(This,pGuideStore);
}
static inline HRESULT IGuideDataLoader_Terminate(IGuideDataLoader* This) {
