/*** Autogenerated by WIDL <undefined version> from videoacc.idl - Do not edit ***/
...
/*** IAMVideoAccelerator methods ***/
static inline HRESULT IAMVideoAccelerator_GetVideoAcceleratorGUIDs(IAMVideoAccelerator* This,LPDWORD pdwNumGuidsSupported,LPGUID pGuidsSupported) {
    return This->lpVtbl->GetVideoAcceleratorGUIDs(This,pdwNumGuidsSupported,pGuidsSupported);
}
static inline HRESULT IAMVideoAccelerator_GetUncompFormatsSupported(IAMVideoAccelerator* This,const GUID *pGuid,LPDWORD pdwNumFormatsSupported,LPDDPIXELFORMAT pFormatsSupported) {
    return This->lpVtbl->GetUncompFormatsSupported(This,pGuid,pdwNumFormatsSupported,pFormatsSupported);
}
static inline HRESULT IAMVideoAccelerator_GetInternalMemInfo(IAMVideoAccelerator* This,const GUID *pGuid,const AMVAUncompDataInfo *pamvaUncompDataInfo,LPAMVAInternalMemInfo pamvaInternalMemInfo) {
    return This->lpVtbl->GetInternalMemInfo(This,pGuid,pamvaUncompDataInfo,pamvaInternalMemInfo);
}
static inline HRESULT IAMVideoAccelerator_GetCompBufferInfo(IAMVideoAccelerator* This,const GUID *pGuid,const AMVAUncompDataInfo *pamvaUncompDataInfo,LPDWORD pdwNumTypesCompBuffers,LPAMVACompBufferInfo pamvaCompBufferInfo) {
    return This->lpVtbl->GetCompBufferInfo(This,pGuid,pamvaUncompDataInfo,pdwNumTypesCompBuffers,pamvaCompBufferInfo);
}
static inline HRESULT IAMVideoAccelerator_GetInternalCompBufferInfo(IAMVideoAccelerator* This,LPDWORD pdwNumTypesCompBuffers,LPAMVACompBufferInfo pamvaCompBufferInfo) {
    return This->lpVtbl->GetInternalCompBufferInfo(This,pdwNumTypesCompBuffers,pamvaCompBufferInfo);
}
static inline HRESULT IAMVideoAccelerator_BeginFrame(IAMVideoAccelerator* This,const AMVABeginFrameInfo *amvaBeginFrameInfo) {
    return This->lpVtbl->BeginFrame(This,amvaBeginFrameInfo);
}
static inline HRESULT IAMVideoAccelerator_EndFrame(IAMVideoAccelerator* This,const AMVAEndFrameInfo *pEndFrameInfo) {
    return This->lpVtbl->EndFrame(This,pEndFrameInfo);
}
static inline HRESULT IAMVideoAccelerator_GetBuffer(IAMVideoAccelerator* This,DWORD dwTypeIndex,DWORD dwBufferIndex,BOOL bReadOnly,LPVOID *ppBuffer,LONG *lpStride) {
    return This->lpVtbl->GetBuffer(This,dwTypeIndex,dwBufferIndex,bReadOnly,ppBuffer,lpStride);
}
static inline HRESULT IAMVideoAccelerator_ReleaseBuffer(IAMVideoAccelerator* This,DWORD dwTypeIndex,DWORD dwBufferIndex) {
    return This->lpVtbl->ReleaseBuffer(This,dwTypeIndex,dwBufferIndex);
}
static inline HRESULT IAMVideoAccelerator_Execute(IAMVideoAccelerator* This,DWORD dwFunction,LPVOID lpPrivateInputData,DWORD cbPrivateInputData,LPVOID lpPrivateOutputDat,DWORD cbPrivateOutputData,DWORD dwNumBuffers,const AMVABUFFERINFO *pamvaBufferInfo) {
...
static inline HRESULT IAMVideoAccelerator_QueryRenderStatus(IAMVideoAccelerator* This,DWORD dwTypeIndex,DWORD dwBufferIndex,DWORD dwFlags) {
    return This->lpVtbl->QueryRenderStatus(This,dwTypeIndex,dwBufferIndex,dwFlags);
}
static inline HRESULT IAMVideoAccelerator_DisplayFrame(IAMVideoAccelerator* This,DWORD dwFlipToIndex,IMediaSample *pMediaSample) {
...
/*** IAMVideoAcceleratorNotify methods ***/
static inline HRESULT IAMVideoAcceleratorNotify_GetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,const GUID *pGuid,LPAMVAUncompBufferInfo pUncompBufferInfo) {
    return This->lpVtbl->GetUncompSurfacesInfo(This,pGuid,pUncompBufferInfo);
}
static inline HRESULT IAMVideoAcceleratorNotify_SetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,DWORD dwActualUncompSurfacesAllocated) {
    return This->lpVtbl->SetUncompSurfacesInfo(This,dwActualUncompSurfacesAllocated);
}
static inline HRESULT IAMVideoAcceleratorNotify_GetCreateVideoAcceleratorData(IAMVideoAcceleratorNotify* This,const GUID *pGuid,LPDWORD pdwSizeMiscData,LPVOID *ppMiscData) {
