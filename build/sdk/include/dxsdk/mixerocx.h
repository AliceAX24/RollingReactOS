/*** Autogenerated by WIDL <undefined version> from mixerocx.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMixerOCXNotify_QueryInterface(IMixerOCXNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMixerOCXNotify_AddRef(IMixerOCXNotify* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMixerOCXNotify_Release(IMixerOCXNotify* This) {
    return This->lpVtbl->Release(This);
}
/*** IMixerOCXNotify methods ***/
static inline HRESULT IMixerOCXNotify_OnInvalidateRect(IMixerOCXNotify* This,LPCRECT lpcRect) {
    return This->lpVtbl->OnInvalidateRect(This,lpcRect);
}
static inline HRESULT IMixerOCXNotify_OnStatusChange(IMixerOCXNotify* This,ULONG ulStatusFlags) {
    return This->lpVtbl->OnStatusChange(This,ulStatusFlags);
}
static inline HRESULT IMixerOCXNotify_OnDataChange(IMixerOCXNotify* This,ULONG ulDataFlags) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMixerOCX_QueryInterface(IMixerOCX* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMixerOCX_AddRef(IMixerOCX* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMixerOCX_Release(IMixerOCX* This) {
    return This->lpVtbl->Release(This);
}
/*** IMixerOCX methods ***/
static inline HRESULT IMixerOCX_OnDisplayChange(IMixerOCX* This,ULONG ulBitsPerPixel,ULONG ulScreenWidth,ULONG ulScreenHeight) {
    return This->lpVtbl->OnDisplayChange(This,ulBitsPerPixel,ulScreenWidth,ulScreenHeight);
}
static inline HRESULT IMixerOCX_GetAspectRatio(IMixerOCX* This,LPDWORD pdwPictAspectRatioX,LPDWORD pdwPictAspectRatioY) {
    return This->lpVtbl->GetAspectRatio(This,pdwPictAspectRatioX,pdwPictAspectRatioY);
}
static inline HRESULT IMixerOCX_GetVideoSize(IMixerOCX* This,LPDWORD pdwVideoWidth,LPDWORD pdwVideoHeight) {
    return This->lpVtbl->GetVideoSize(This,pdwVideoWidth,pdwVideoHeight);
}
static inline HRESULT IMixerOCX_GetStatus(IMixerOCX* This,LPDWORD *pdwStatus) {
    return This->lpVtbl->GetStatus(This,pdwStatus);
}
static inline HRESULT IMixerOCX_OnDraw(IMixerOCX* This,HDC hdcDraw,LPCRECT prcDraw) {
    return This->lpVtbl->OnDraw(This,hdcDraw,prcDraw);
}
static inline HRESULT IMixerOCX_SetDrawRegion(IMixerOCX* This,LPPOINT lpptTopLeftSC,LPCRECT prcDrawCC,LPCRECT lprcClip) {
    return This->lpVtbl->SetDrawRegion(This,lpptTopLeftSC,prcDrawCC,lprcClip);
}
static inline HRESULT IMixerOCX_Advise(IMixerOCX* This,IMixerOCXNotify *pmdns) {
    return This->lpVtbl->Advise(This,pmdns);
}
static inline HRESULT IMixerOCX_UnAdvise(IMixerOCX* This) {
