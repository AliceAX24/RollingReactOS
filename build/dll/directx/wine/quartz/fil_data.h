/*** Autogenerated by WIDL <undefined version> from fil_data.idl - Do not edit ***/
...
/*** IAMFilterData methods ***/
static inline HRESULT IAMFilterData_ParseFilterData(IAMFilterData* This,BYTE *rgbFilterData,ULONG cb,BYTE **prgbRegFilter2) {
    return This->lpVtbl->ParseFilterData(This,rgbFilterData,cb,prgbRegFilter2);
}
static inline HRESULT IAMFilterData_CreateFilterData(IAMFilterData* This,REGFILTER2 *prf2,BYTE **prgbFilterData,ULONG *pcb) {
