/*** Autogenerated by WIDL <undefined version> from dcom.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IRemUnknown_QueryInterface(IRemUnknown* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IRemUnknown_AddRef(IRemUnknown* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IRemUnknown_Release(IRemUnknown* This) {
    return This->lpVtbl->Release(This);
}
/*** IRemUnknown methods ***/
static inline HRESULT IRemUnknown_RemQueryInterface(IRemUnknown* This,REFIPID ripid,ULONG cRefs,unsigned short cIids,IID *iids,REMQIRESULT **ppQIResults) {
    return This->lpVtbl->RemQueryInterface(This,ripid,cRefs,cIids,iids,ppQIResults);
}
static inline HRESULT IRemUnknown_RemAddRef(IRemUnknown* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs,HRESULT *pResults) {
    return This->lpVtbl->RemAddRef(This,cInterfaceRefs,InterfaceRefs,pResults);
}
static inline HRESULT IRemUnknown_RemRelease(IRemUnknown* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs) {
