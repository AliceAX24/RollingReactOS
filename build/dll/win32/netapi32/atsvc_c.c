/*** Autogenerated by WIDL <undefined version> from /home/alice/Estudos/ReactOS/ReactOSRCCompile1/sdk/include/reactos/idl/atsvc.idl - Do not edit ***/
#include <string.h>
    ...
    DWORD MaxJobId)
{
    ...
    __params.ServerName = ServerName;
    __params.MinJobId = MinJobId;
    __params.MaxJobId = MaxJobId;
    _RetVal = NdrClientCall2( &atsvc_StubDesc,
    ...
    LPDWORD pResumeHandle)
{
    ...
    __params.ServerName = ServerName;
    __params.pEnumContainer = pEnumContainer;
    __params.PreferedMaximumLength = PreferedMaximumLength;
    __params.pTotalEntries = pTotalEntries;
    __params.pResumeHandle = pResumeHandle;
    _RetVal = NdrClientCall2( &atsvc_StubDesc,
...
/* 106 */
        ...
        0x0,
        NdrFcShort(0xffc7),	/* Offset= -57 (54) */
        0x5b,	/* FC_END */
/* 114 (struct _AT_ENUM_CONTAINER) */
        0x16,	/* FC_PSTRUCT */
        0x3,	/* 3 */
        NdrFcShort(0x8),	/* 8 */
        0x4b,	/* FC_PP */
...
/* 150 (LPAT_INFO) */
        0x12, 0x0,		/* FC_UP */
        NdrFcShort(0xff72),	/* Offset= -142 (10) */
/* 154 (LPAT_INFO *) */
